/**
 * JAYT RELEASE CANDIDATE EMITTER (092A)
...
const targetRcPath = path.join(repoRoot, '08_RELEASE_VAULT', 'RELEASE_CANDIDATE_092A.json');
...
console.log(`✅ [RC-092A-EMITTED] Đã tạo thành công Release Candidate 092A: ${targetRcPath}`);
