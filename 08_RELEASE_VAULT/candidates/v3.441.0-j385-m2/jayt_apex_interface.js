...
const J372_CAMPUS_MAPPING = {
  ...
  "clusters": [
    ...
    "excluded_from_student_feed": true,
    "is_party_combo": true,
    "party_budget_note": "Vượt ngân sách sinh viên thông thường (>65k/người); dành cho tiệc nhóm lớn",
          "brand": "The Pizza Company",
...
const state = {
  ...
  lunchAppExclusions: { shopeefood: false, grabfood: false, xanhsm: false },
...
function calculateLunchComparison(dishPrice, appConfigs, bridgeSurcharge) {
  const price = Math.max(25000, Math.min(150000, parseInt(dishPrice, 10) || 35000));
  ...
  const configs = appConfigs || {
    shopeefood: { 
      ...
      discount: 15000, 
      color: '#EA580C',
      available: !state.lunchAppExclusions?.shopeefood 
    },
    grabfood: { 
      name: 'GrabFood', 
      deliveryFee: 18000, 
      ...
      discount: 12000, 
      color: '#047857',
      available: !state.lunchAppExclusions?.grabfood 
    },
    xanhsm: { 
      name: 'Xanh SM', 
      deliveryFee: 15000, 
      ...
      discount: 10000, 
      color: '#0284C7',
      available: !state.lunchAppExclusions?.xanhsm 
    }
  };
...
const J385_ECOSYSTEMS = [
  ...
  { 
    ...
    icon: '🍗',
    providers: ['ShopeeFood', 'GrabFood', 'Xanh SM', 'Jollibee', 'The Pizza Company', 'Popeyes'],
    desc: 'Ưu đãi cơm trưa, gà rán, pizza và so sánh cước giao hàng 3 sàn'
  },
  { 
    key: 'dorm', 
...
function getFilteredOffers() {
  ...
  return J372_OFFERS.filter(offer => {
    // 1. Strict Student Budget Feed Predicate on default storefront
    if (state.storefrontFeedFilter === 'STUDENT_BUDGET' && !isStudentBudgetOffer(offer)) {
      return false;
    }

    // 2. Party combos (>400k) excluded unless explicitly requested
    if (offer.excluded_from_student_feed && !state.showPartyCombos) {
      return false;
    }

    // 3. Cluster filter if selected
    if (applicableIds && !applicableIds.has(offer.offer_id)) {
      return false;
    }

    // 4. Five Ecosystem filter if selected
...
function renderClusterSummaryPanel() {
  ...
  const feedSwitcherHtml = `
    <div class="storefront-feed-switcher" role="tablist" aria-label="Chế độ hiển thị danh sách ưu đãi" style="display: flex; gap: 10px; flex-wrap: wrap; margin-top: 14px; padding-top: 12px; border-top: 1px solid var(--border-color);">
      ...
      >
        🎓 Mặt tiền sinh viên (≤45k &amp; Đặc quyền 0đ) [${studentCount}]
      </button>
      <button 
        type="button" 
      ...
      >
        🌐 Khám phá tất cả ưu đãi đối tác [${allCount}]
      </button>
    </div>
  `;
...
const J385_DORM_SKUS = [
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_dienquang_official",
    ...
    "partner_attribution_ready": true,
    ...
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_173829101"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_jisulife_vietnam",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_281940192"
  },
  {
    ...
    "platform": "Lazada",
    "merchant_id": "lazmall_sunhouse_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "LAZMALL_PRODUCT_LEAF_94820194"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_bear_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_392019481"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_rangdong_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_482019482"
  },
  {
    ...
    "merchant_id": "tiktok_mall_kapi_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "TIKTOK_SHOP_MALL_172948102948102"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_everon_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_592019481"
  },
  {
    ...
    "platform": "Lazada",
    "merchant_id": "lazmall_lotus_bedding",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "LAZMALL_PRODUCT_LEAF_84920194"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_ema_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_682019482"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_locknlock_flagship",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_782019481"
  },
  {
    ...
    "platform": "Lazada",
    "merchant_id": "lazmall_elmich_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "LAZMALL_PRODUCT_LEAF_74920194"
  },
  {
    ...
    "platform": "TikTok Shop",
    "merchant_id": "tiktok_mall_oenon_vietnam",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "TIKTOK_SHOP_MALL_172948102948201"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_dega_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_882019482"
  },
  {
    ...
    "platform": "TikTok Shop",
    "merchant_id": "tiktok_mall_homful_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "TIKTOK_SHOP_MALL_172948102948305"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_inochi_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_982019481"
  },
  {
    ...
    "platform": "Lazada",
    "merchant_id": "lazmall_philips_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "LAZMALL_PRODUCT_LEAF_64920194"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_chaoba_vietnam",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_108201948"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_brita_vietnam",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_118201948"
  },
  {
    ...
    "platform": "TikTok Shop",
    "merchant_id": "tiktok_mall_ehome_living",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "TIKTOK_SHOP_MALL_172948102948410"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_mujihome_store",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_128201948"
  },
  {
    ...
    "platform": "Lazada",
    "merchant_id": "lazmall_comet_electric",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "LAZMALL_PRODUCT_LEAF_54920194"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_logitech_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_138201948"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_rapoo_vietnam",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_148201948"
  },
  {
    ...
    "platform": "Lazada",
    "merchant_id": "lazmall_jbl_flagship",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "LAZMALL_PRODUCT_LEAF_44920194"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_simplecarry_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_158201948"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_bitex_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_168201948"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_klong_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_178201948"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_thienlong_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_188201948"
  },
  {
    ...
    "platform": "Lazada",
    "merchant_id": "lazmall_locknlock_flagship",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "LAZMALL_PRODUCT_LEAF_34920194"
  },
  {
    ...
    "platform": "Shopee",
    "merchant_id": "shopee_mall_deli_official",
    ...
    "price_history_reference": "OBSERVED_AT_DATE_ONLY",
    "price_label": "Giá quan sát ngày 10/09/2026",
    "evidence_source": "SHOPEE_MALL_PRODUCT_LEAF_198201948"
  }
];
...
function renderDormSkusSection() {
  ...
  const categories = [
    { key: 'ALL', label: 'Tất cả 30 món', count: J385_DORM_SKUS.length },
    { key: 'Gia dụng KTX', label: 'Gia dụng KTX', count: J385_DORM_SKUS.filter(s => s.category === 'Gia dụng KTX').length },
    { key: 'Học tập & Công nghệ', label: 'Học tập & Công nghệ', count: J385_DORM_SKUS.filter(s => s.category === 'Học tập & Công nghệ').length },
    { key: 'Phòng ngủ & Tiện ích', label: 'Phòng ngủ & Tiện ích', count: J385_DORM_SKUS.filter(s => s.category === 'Phòng ngủ & Tiện ích').length },
    { key: 'Sinh hoạt & Giặt ủi', label: 'Sinh hoạt & Giặt ủi', count: J385_DORM_SKUS.filter(s => s.category === 'Sinh hoạt & Giặt ủi').length },
    { key: 'Cá nhân', label: 'Cá nhân', count: J385_DORM_SKUS.filter(s => s.category === 'Cá nhân').length }
  ];

  let filteredSkus = J385_DORM_SKUS;
  if (selectedCat !== 'ALL') {
...
function renderLunchArbitrageModule() {
  ...
  return `
    <section id="lunch-arbitrage-module" class="bento-section" aria-labelledby="title-lunch-module">
      <div class="container">
        <div class="section-header">
          <h2 id="title-lunch-module" class="section-title">🍱 Công Cụ So Sánh Chi Phí Bữa Trưa 3 Sàn (Đà Nẵng)</h2>
          <p class="section-desc">Thanh trượt ngân sách 25.000₫ – 150.000₫ so sánh chi phí thực trả giữa ShopeeFood, GrabFood và Xanh SM kèm phụ phí vượt cầu.</p>
        </div>
            ...
            <div class="calc-control-panel">
              <div class="input-field-group">
                ...
                <input 
                  ...
                  aria-label="Thanh trượt ngân sách tiền món từ 25.000₫ đến 150.000₫"
                />
              ...
              <div class="disclaimer-note" style="background: rgba(0,0,0,0.02); border: 1px dashed var(--border-color); border-radius: var(--radius-control); padding: 8px 12px; font-size: 12px; color: var(--text-muted); line-height: 1.4;">
                <span>ℹ️</span>
                <span>Cước/giá so sánh chỉ phản ánh dữ liệu người dùng nhập và biểu phí ước tính tại Đà Nẵng; không tuyên bố là giá trực tiếp rẻ nhất thị trường khi chưa kết nối API thời gian thực.</span>
              </div>
            </div>
                ...
                <div class="app-calc-card ${app.isBest ? 'is-winner' : ''}">
                  ...
                  ` : `
                    <div style="padding: 16px 0; color: var(--text-muted); font-size: 13px;">
                      Dịch vụ hiện chưa khả dụng tại tuyến giao này
                    </div>
                  `}
                </div>
              `).join('')}
...
function renderDormShoppingModule() {
  ...
  const filteredProducts = J385_DORM_SKUS.filter(p => {
