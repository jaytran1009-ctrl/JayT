        ...
        <div class="split-bill-container">
          ...
          <div class="split-card">
            ...
            <div style="display: flex; gap: 10px; margin-top: 20px;">
              <button type="button" id="btn-calculate-split" style="flex: 1; background: #0284c7; color: #ffffff; border: none; padding: 12px 20px; border-radius: 8px; font-weight: 700; font-size: 0.95rem; cursor: pointer; min-height: 44px;">
                🧮 Tính toán &amp; Soạn tin
              </button>
        ...
        resContainer.innerHTML = `
          <div class="split-results-panel">
            ...
            <div style="display: flex; gap: 10px; margin-top: 14px; flex-wrap: wrap;">
              <button type="button" id="btn-copy-zalo-msg" style="flex: 1; background: #059669; color: #ffffff; border: none; padding: 12px 18px; border-radius: 8px; font-weight: 700; font-size: 0.9rem; cursor: pointer; display: inline-flex; align-items: center; justify-content: center; gap: 6px; min-height: 44px;">
          ...
          ${dayData.items.map(item => `
            <article class="vault-card" style="border-left: 4px solid #0284c7;">
              <div class="vault-card-header">
                ...
                <span style="font-size: 0.78rem; font-weight: 700; color: #0284c7;">📅 ${item.frequency}</span>
              </div>
    ...
    return `
      <article class="radar-card" data-category="${item.category}" aria-label="${item.name}">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 10px; gap: 6px;">
          <span style="font-size: 0.75rem; font-weight: 700; color: #0284c7; background: rgba(2, 132, 199, 0.1); padding: 3px 8px; border-radius: 4px;">
            ${categoryLabel}
          </span>
        ...
        <h3 style="font-size: 1.05rem; font-weight: 800; color: var(--text-primary); margin: 0 0 8px 0; line-height: 1.4;">
          ${item.name}
        </h3>
