          ...
          <div class="bill-split-grid">
            ...
            <div style="display: flex; flex-direction: column; gap: var(--space-4);">
              ...
              <div class="bill-panel-card">
                ...
                ` : `
                  <!-- Confirmed Review State with Rendered QR -->
                  <div class="qr-confirmation-card">
                    <div class="qr-confirmation-row">
                      <strong>Ngân hàng:</strong>
                      <span>${activeBank ? activeBank.short_name : onsiteState.recipientBankBin}</span>
                    </div>
                    <div class="qr-confirmation-row">
                      <strong>Số tài khoản:</strong>
                      <span class="font-mono" style="font-weight: 700;">${onsiteState.recipientAccount}</span>
                    </div>
                    <div class="qr-confirmation-row">
                      <strong>Tên người nhận:</strong>
                      <span>${onsiteState.recipientDisplayName || '(Tên bạn tự nhập)'}</span>
                    </div>
                    <div class="qr-confirmation-row">
                    ...
                    <div class="qr-confirmation-row" style="border-top: 1px dashed var(--border-color); padding-top: 4px;">
                      <strong>Số tiền phải trả:</strong>
                      <span style="font-weight: 800; font-size: 1.1rem; color: var(--color-action);">${activeShare.totalShare.toLocaleString('vi-VN')}₫</span>
                    </div>
