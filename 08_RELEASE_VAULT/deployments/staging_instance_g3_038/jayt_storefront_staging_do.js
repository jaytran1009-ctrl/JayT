/**
 * JAYT COMMUNITY OS — CURATED LOCAL EDITORIAL DISCOVERY (SECTION DO)
 * Release Candidate: v3.443.0-staging.do
 * Governing Directive: JAYT-245 Section DO (Lines 2836-2853)
 */
...
(function() {
  ...
  if (typeof window !== 'undefined' && window.JAYT_OBSERVABILITY) {
    window.JAYT_OBSERVABILITY.recordEvent('STOREFRONT_INITIALIZED', {
      version: 'v3.443.0-staging.do',
      environment: 'STAGING_REVIEW_DO',
  ...
  if (typeof window !== 'undefined') {
    window.JAYT_STOREFRONT_VERSION = 'v3.443.0-staging.do';
  }
  ...
  // 1. CURATED LOCAL EDITORIAL SPOTLIGHT CARD (SECTION DO)
  function renderCuratedSpotlightCard(item, reasonText) {
    const isSaved = savedItemIds.has(item.item_id);
    const action = resolveActionContract(item);
  ...
  function renderDailyGuideHome() {
    ...
    return `
      <div class="cr-experience-container">
        ...
        <div class="bento-hero-grid" aria-label="Bảng Điều Khiển Khám Phá Hôm Nay">
          ...
          <section class="bento-tile-main-stage hero-landmark-cr vivid-dragon-hero-cf" aria-label="Bìa Khám Phá Đà Nẵng">
            ...
            <div class="bento-stage-content hero-landmark-content">
              ...
              <!-- HERO DECISION HIERARCHY (SECTION DO: STATE-AWARE PRIMARY CTA) -->
        ...
        <!-- 2. QUICK DISCOVERY CATEGORIES STRIP (SECTION DO: SINGLE SOURCE OF COUNT INVARIANT) -->
        ...
        <!-- 4. RAIL 1: EDITORIAL CURATED SPOTLIGHTS (SECTION DO: GENUINE EDITORIAL SELECTION) -->
        <section id="featured-deals-section" aria-label="Tuyển Chọn Nổi Bật Hôm Nay">
          ...
          <div class="editorial-curated-grid">
            ${curatedHighlights.map(c => renderCuratedSpotlightCard(c.item, c.reason)).join('')}
          </div>
        </section>

        <!-- 5. RAIL 2: CỔNG THÔNG TIN & CHƯƠNG TRÌNH HỌC ĐƯỜNG (SECTION DO) -->
  ...
  // 5. OFFICIAL PROGRAMMES & PORTALS VIEW (SECTION DO)
  ...
  // 9. PROGRESSIVE DISCLOSURE DETAIL DRAWER WITH FULL TAB-CYCLE FOCUS TRAP (SECTION DO)
    ...
    root.innerHTML = `
      <div class="jayt-app-shell theme-${currentTheme}">
          ...
          <div class="header-inner">
            <div class="brand-lockup" role="button" tabindex="0" data-nav="HOME" aria-label="Về trang chủ JayT Đà Nẵng">
              <svg width="28" height="28" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path d="M19 6 V19 C19 24.5 15.5 28 10 28 C6.5 28 4.2 26 3.5 24 C5.2 24 7 22.8 7.5 20.8 C8 18.5 6.5 16.5 4.5 16.5 C3.8 16.5 3 16.8 2.5 17.2 C3.5 10.5 11 6 19 6 Z" fill="url(#jflow-logo-grad-do)"/>
                <path d="M19 14 C23.5 14 27.5 17 29.5 21 C31 24 32.5 28 33.5 31 C29.5 29 25 27.5 19 27.5 V21.5 C22 21.5 24.5 23 26 24.5 C24.5 20 20.5 17.5 16 17 L19 14 Z" fill="url(#jflow-logo-grad-do)" opacity="0.9"/>
                <circle cx="27" cy="8" r="3.5" fill="#f43f5e"/>
                <defs>
                  <linearGradient id="jflow-logo-grad-do" x1="4" y1="4" x2="34" y2="34" gradientUnits="userSpaceOnUse">
              ...
              <div class="brand-text-group">
                ...
                <span class="brand-tagline">Khám Phá Mỗi Ngày &bull; v3.443.0-staging.do</span>
              </div>
            </div>
        ...
        <footer style="text-align: center; padding: 32px 16px; font-size: 0.8rem; color: var(--text-muted); border-top: 1px solid var(--border-color);" role="contentinfo">
          <div>JayT Đà Nẵng &bull; Chuẩn Tuyển Chọn Bản Địa DO &bull; v3.443.0-staging.do</div>
        </footer>
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
      JAYT_STOREFRONT_VERSION: 'v3.443.0-staging.do',
