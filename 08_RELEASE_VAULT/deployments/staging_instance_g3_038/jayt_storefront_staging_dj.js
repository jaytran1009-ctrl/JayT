/**
 * JAYT COMMUNITY OS — PREMIUM MODERN BENTO & PROGRESSIVE DISCLOSURE (SECTION DJ)
 * Release Candidate: v3.438.0-staging.dj
 * Governing Directive: JAYT-245 Section DJ (Lines 2695-2722)
 */
...
(function() {
  ...
  if (typeof window !== 'undefined' && window.JAYT_OBSERVABILITY) {
    window.JAYT_OBSERVABILITY.recordEvent('STOREFRONT_INITIALIZED', {
      version: 'v3.438.0-staging.dj',
      environment: 'STAGING_REVIEW_DJ',
      theme: 'PREMIUM_BENTO_DJ',
      dom_isolation: 'STRICT_ZERO_DOM_INJECTION'
    });
  }

  if (typeof window !== 'undefined') {
    window.JAYT_STOREFRONT_VERSION = 'v3.438.0-staging.dj';
  }

  // 1. DATA LEDGER (50 SANITIZED HONEST TIERED ITEMS: 0 T1, 20 T2, 18 T3, 12 T4)
  const JAYT_DISCOVERY_ITEMS = [
  {
    ...
    "evidence_status": "Cổng thông tin chính thức • www.cgv.vn",
  ...
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • dominos.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • www.lotteria.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • metiz.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • education.github.com",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • www.notion.so",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • www.canva.com",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • www.jetbrains.com",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • www.spotify.com",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • www.apple.com",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • starlight.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • www.galaxycine.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • coopmart.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • shopee.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • www.grab.com",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • be.com.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • fptplay.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
  ...
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • danangbus.vn",
  ...
  },
  {
    ...
    "tier_badge_class": "tier-badge-programme",
    "specific_action_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Cổng thông tin chính thức • tngo.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "specific_action_label": "📍 Xem tiện ích & Maps →",
    "evidence_status": "Địa điểm công cộng xác minh • TP. Đà Nẵng",
    "visual_asset_url": "assets/images/danang_real_photo_bach_dang.jpg",
    "visual_attribution": "📚 Bạch Đằng Ven Sông (1280x853px) &bull; 📷 Joseph Hunkins (CC BY 2.0)"
  },
  {
  ...
  },
  {
    ...
    "visual_attribution": "🏛️ Bảo Tàng Chăm (1280x853px) &bull; 📷 CT Snow (CC BY 2.0)"
  },
  {
  ...
  },
  {
    ...
    "visual_attribution": "🍜 Mì Quảng (1280x853px) &bull; 📷 SauceSupreme (CC BY 2.0)"
  },
  {
  ...
  },
  {
    ...
    "evidence_status": "Kênh giám sát nguồn tin • vincom.com.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-radar",
    "specific_action_label": "📡 Theo dõi kênh →",
    "evidence_status": "Kênh giám sát nguồn tin • www.lottemart.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-radar",
    "specific_action_label": "📡 Theo dõi kênh →",
    "evidence_status": "Kênh giám sát nguồn tin • go-vietnam.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-radar",
    "specific_action_label": "📡 Theo dõi kênh →",
    "evidence_status": "Kênh giám sát nguồn tin • kichi.com.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-radar",
    "specific_action_label": "📡 Theo dõi kênh →",
    "evidence_status": "Kênh giám sát nguồn tin • gogi.com.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-radar",
    "specific_action_label": "📡 Theo dõi kênh →",
    "evidence_status": "Kênh giám sát nguồn tin • thecoffeehouse.com",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-radar",
    "specific_action_label": "📡 Theo dõi kênh →",
    "evidence_status": "Kênh giám sát nguồn tin • trungnguyenlegend.com",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-radar",
    "specific_action_label": "📡 Theo dõi kênh →",
    "evidence_status": "Kênh giám sát nguồn tin • mxbc.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-radar",
    "specific_action_label": "📡 Theo dõi kênh →",
    "evidence_status": "Kênh giám sát nguồn tin • www.cgv.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
    ...
    "tier_badge_class": "tier-badge-radar",
    "specific_action_label": "📡 Theo dõi kênh →",
    "evidence_status": "Kênh giám sát nguồn tin • www.galaxycine.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  },
  {
  ...
  },
  {
    ...
    "tier_badge_class": "tier-badge-radar",
    "specific_action_label": "📡 Theo dõi kênh →",
    "evidence_status": "Kênh giám sát nguồn tin • helio.vn",
    "visual_asset_url": null,
    "visual_attribution": null
  }
];
  ...
  const JAYT_WALLET_ENTRIES = [
  {
    ...
    "evidence_status": "Nguồn đối soát: education.github.com • Cập nhật định kỳ"
  },
  {
    ...
    "official_source_url": "https://www.notion.so/product/notion-for-education",
    "action_button_label": "🏛️ Mở cổng chính thức để kiểm tra điều kiện →",
    "evidence_status": "Nguồn đối soát: www.notion.so • Cập nhật định kỳ"
  },
  {
    ...
    "official_source_url": "https://www.canva.com/education/",
    "action_button_label": "🏛️ Mở cổng chính thức để kiểm tra điều kiện →",
    "evidence_status": "Nguồn đối soát: www.canva.com • Cập nhật định kỳ"
  },
  {
    ...
    "official_source_url": "https://danangbus.vn",
    "action_button_label": "🏛️ Mở cổng chính thức để kiểm tra điều kiện →",
    "evidence_status": "Nguồn đối soát: danangbus.vn • Cập nhật định kỳ"
  },
  {
    ...
    "official_source_url": "https://www.cgv.vn",
    "action_button_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Nguồn đối soát: www.cgv.vn • Cập nhật định kỳ"
  },
  {
    ...
    "action_button_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Nguồn đối soát: dominos.vn • Cập nhật định kỳ"
  },
  {
    ...
    "action_button_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Nguồn đối soát: www.lotteria.vn • Cập nhật định kỳ"
  },
  {
    ...
    "action_button_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Nguồn đối soát: metiz.vn • Cập nhật định kỳ"
  },
  {
    ...
    "action_button_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Nguồn đối soát: starlight.vn • Cập nhật định kỳ"
  },
  {
    ...
    "official_source_url": "https://tngo.vn",
    "action_button_label": "🏛️ Mở cổng chính thức →",
    "evidence_status": "Nguồn đối soát: tngo.vn • Cập nhật định kỳ"
  },
  {
    ...
    "evidence_status": "Nguồn đối soát: highlandscoffee.com.vn • Cập nhật định kỳ"
  },
  {
    ...
    "official_source_url": "https://phuclong.com.vn",
    "action_button_label": "📡 Theo dõi kênh chính thức →",
    "evidence_status": "Nguồn đối soát: phuclong.com.vn • Cập nhật định kỳ"
  },
  {
    ...
    "official_source_url": "https://vincom.com.vn",
    "action_button_label": "📡 Theo dõi kênh chính thức →",
    "evidence_status": "Nguồn đối soát: vincom.com.vn • Cập nhật định kỳ"
  }
];
  ...
  function getCurrentTimeSlotInfo() {
    ...
    if (hour >= 5 && hour < 11) {
      return { slot: 'SLOT_MORNING', label: 'Sáng nay', momentTag: '🌅 BUỔI SÁNG &bull; ĐẶC QUYỀN ĐIỂM TÂM & CÀ PHÊ ĐÀ THÀNH', momentDesc: 'Khung giờ điểm tâm, cà phê ven sông và mạng lưới buýt DanaBus kết nối liên quận.' };
    } else if (hour >= 11 && hour < 14) {
      return { slot: 'SLOT_LUNCH', label: 'Trưa nay', momentTag: '🍜 BUỔI TRƯA &bull; ẨM THỰC TIẾP SỨC ĐÀ THÀNH', momentDesc: 'Thực đơn trưa văn phòng, mì Quảng truyền thống và ẩm thực Hải Châu.' };
  ...
  // RENDER CARD WITH PROGRESSIVE DISCLOSURE (SECTION DJ: CLEAN FRONT SURFACE)
    ...
    return `
      <article class="rail-card-cn" data-item-id="${item.item_id}">
        ...
        <div class="rail-footer-actions-row">
          ...
          ${item.map_query_url ? `
            <a href="${item.map_query_url}" target="_blank" rel="noopener noreferrer" class="btn-rail-map" title="Xem bản đồ Maps">
              📍 Maps
            </a>
          ` : ''}
        </div>
  ...
  // 1. MODERN BENTO COMMERCE HOME VIEW (SECTION DJ: HIERARCHY & DATA-STATE)
  function renderDailyGuideHome() {
    const timeInfo = getCurrentTimeSlotInfo();
    const featuredCards = JAYT_DISCOVERY_ITEMS.slice(0, 6);

    return `
      <div class="cr-experience-container">
        <!-- MODERN BENTO HERO GRID -->
        <div class="bento-hero-grid" aria-label="Bảng Điều Khiển Bento Đà Nẵng">
          <!-- BENTO TILE 1: MAIN STAGE (8 COLUMNS DESKTOP) -->
          <section class="bento-tile-main-stage hero-landmark-cr vivid-dragon-hero-cf" aria-label="Bìa Đặc Quyền Đà Nẵng">
            <img 
            ...
            <div class="hero-landmark-attribution" tabindex="0" role="note" aria-label="Thông tin bản quyền ảnh Cầu Rồng">
            ...
            <div class="bento-stage-content hero-landmark-content">
              ...
              <p class="hero-subhead-cr vivid-subhead">
                Đặc quyền thật cho hôm nay ở Đà Nẵng: Mở cổng chính thức các chính sách học đường, ví voucher 3 làn và tiện ích đô thị minh bạch.
              </p>

              <!-- HERO DECISION HIERARCHY (SECTION DJ: 1 PRIMARY STANDOUT + 2 SECONDARY/TERTIARY) -->
              <div class="hero-shopping-actions-grid">
                <!-- 1. PRIMARY ACTION (SOLID PROMINENT) -->
                <button class="btn-hero-primary-solid" data-nav="EXPLORE" data-tier-filter="TIER_2_PROGRAMME">
                  🏛️ Xem ưu đãi & cổng đang kiểm &rarr;
                </button>
                <!-- 2. SECONDARY ACTION (GLASS OUTLINE) -->
                <button class="btn-hero-secondary-outline" data-nav="WALLET">
                  🎟️ Ví Voucher (13) &rarr;
                </button>
                <!-- 3. TERTIARY ACTION (GHOST TEXT) -->
                <button class="btn-hero-tertiary-ghost" data-nav="BUY_DECISION">
          ...
          <div class="bento-side-column">
            ...
            <div class="bento-tile-moment">
              ...
              <div class="bento-moment-chips">
                <button class="bento-chip-btn ${activeMealMoment === 'ALL' ? 'active' : ''}" data-nav="FOOD_JOURNEY" data-meal-moment="ALL">Tất cả</button>
                <button class="bento-chip-btn ${activeMealMoment === 'SANG' ? 'active' : ''}" data-nav="FOOD_JOURNEY" data-meal-moment="SANG">🌅 Sáng</button>
                <button class="bento-chip-btn ${activeMealMoment === 'TRUA' ? 'active' : ''}" data-nav="FOOD_JOURNEY" data-meal-moment="TRUA">🍜 Trưa</button>
                <button class="bento-chip-btn ${activeMealMoment === 'CHIEU' ? 'active' : ''}" data-nav="FOOD_JOURNEY" data-meal-moment="CHIEU">☕ Chiều</button>
                <button class="bento-chip-btn ${activeMealMoment === 'TOI' ? 'active' : ''}" data-nav="LEISURE_JOURNEY" data-meal-moment="TOI">✨ Tối</button>
              </div>
            </div>

            <!-- BENTO TILE 3: QUICK WALLET & SAVED DOCK -->
            <div class="bento-tile-dock">
              <div>
                <span class="dock-badge">⚡ TRUY CẬP NHANH</span>
                <h3 style="font-size: 1.05rem; font-weight: 700; margin: 4px 0;">Ví Quyền Lợi & Danh Sách</h3>
              </div>
              <div class="bento-dock-row">
                <button class="bento-dock-btn" data-nav="WALLET">
                  <span class="bento-dock-icon">🎟️</span>
                  <span>Ví Voucher (13)</span>
                </button>
                <button class="bento-dock-btn" data-nav="SAVED">
                  <span class="bento-dock-icon">❤️</span>
        ...
        <!-- 3. RAIL 1: CỔNG CHÍNH THỨC & TIỆN ÍCH ĐÔ THỊ -->
        <section id="featured-deals-section" aria-label="Cổng Chính Thức & Tiện Ích Đô Thị">
          <div class="section-flow-header">
            <div>
              <h2 class="section-flow-title">🏛️ Cổng Ưu Đãi & Chính Sách Chính Thức Đang Kiểm</h2>
              <p class="section-flow-subtitle">Các cổng thông tin và chương trình học đường chính thức tại Đà Nẵng. Nhấp vào thẻ để xem chi tiết căn cứ và thể lệ.</p>
            </div>
          ...
          <div class="cards-layout-grid">
            ${featuredCards.map(item => renderRailCard(item)).join('')}
          </div>
        </section>

        <!-- 4. RAIL 2: VOUCHER QUYỀN LỢI (SECTION DJ: FAIL-CLOSED CỔNG CHÍNH THỨC) -->
        <section aria-label="Ví Voucher Đặc Quyền Học Đường">
          <div class="section-flow-header">
            <div>
              <h2 class="section-flow-title">🎟️ Ví Thông Tin & Đặc Quyền Học Đường (13 Chính Sách)</h2>
              <p class="section-flow-subtitle">Toàn bộ 13 quyền lợi được phân loại minh bạch giữa Cổng chính thức và Kênh theo dõi.</p>
            </div>
        ...
        <!-- 5. RAIL 3: MOMENT-CURATED REAL PHOTO SPOTLIGHTS -->
        <section aria-label="Điểm Hẹn & Tiện Ích Theo Khoảnh Khắc">
          <div class="section-flow-header">
            <div>
              <h2 class="section-flow-title">📍 Không Gian Đô Thị Tiêu Biểu Theo Khoảnh Khắc</h2>
              <p class="section-flow-subtitle">Hình ảnh thực tế xác thực từ các danh thắng và tiện ích công cộng tại Đà Nẵng.</p>
            </div>
          </div>
            ...
            <article class="moment-card-cw spotlight-visual-stage-cn" id="journey-transport">
              <div class="moment-media-wrap">
                <img 
                  ...
                  alt="Cầu Quay Sông Hàn & Giao Thông Đô Thị Đà Nẵng (1200x800px)" 
                  class="moment-media-img spotlight-visual-img-cn" 
                  loading="eager"
                />
                <div class="moment-attribution-tag spotlight-visual-attribution-tag">
                  🌉 Cầu Sông Hàn (1200x800px) &bull; 📷 Christophe95 (CC BY-SA 4.0)
                </div>
              </div>
              <div class="moment-content-box">
                <span class="moment-kicker">🚌 SAU GIỜ HỌC & LÀM</span>
                <h3 class="moment-title">Xe Buýt DanaBus & Cầu Sông Hàn</h3>
                <p class="moment-desc">Mạng lưới buýt trợ giá đô thị kết nối liên quận trên toàn địa bàn TP. Đà Nẵng.</p>
                <div class="moment-actions">
            ...
            <article class="moment-card-cw spotlight-visual-stage-cn" id="journey-study">
              <div class="moment-media-wrap">
                <img 
                  ...
                  alt="Đường Bạch Đằng ven sông Hàn & Thư Viện KHTH (1280x853px)" 
                  class="moment-media-img spotlight-visual-img-cn" 
                  loading="eager"
                />
                <div class="moment-attribution-tag spotlight-visual-attribution-tag">
                  📚 Bạch Đằng Ven Sông (1280x853px) &bull; 📷 Joseph Hunkins (CC BY 2.0)
                </div>
              </div>
              <div class="moment-content-box">
                <span class="moment-kicker">🎓 KHÔNG GIAN TỰ HỌC</span>
                <h3 class="moment-title">Thư Viện KHTH Đường Bạch Đằng</h3>
                <p class="moment-desc">Không gian đọc sách tại chỗ, phòng máy lạnh và wifi miễn phí cho độc giả Đà Nẵng.</p>
                <div class="moment-actions">
            ...
            <article class="moment-card-cw spotlight-visual-stage-cn" id="journey-leisure">
              <div class="moment-media-wrap">
                <img 
                  ...
                  alt="Bảo Tàng Điêu Khắc Chăm Đà Nẵng (1280x853px)" 
                  class="moment-media-img spotlight-visual-img-cn" 
                  loading="eager"
                />
                <div class="moment-attribution-tag spotlight-visual-attribution-tag">
                  🏛️ Bảo Tàng Chăm (1280x853px) &bull; 📷 CT Snow (CC BY 2.0)
                </div>
              </div>
              <div class="moment-content-box">
                <span class="moment-kicker">✨ ĐI CHƠI TỐI NAY</span>
                <h3 class="moment-title">Bảo Tàng Điêu Khắc Chăm</h3>
                <p class="moment-desc">Không gian văn hóa di sản điêu khắc Champa ngay đầu Cầu Rồng và dạo mát phố đi bộ về đêm.</p>
                <div class="moment-actions">
        ...
        <section class="dock-tiles-grid-cr" aria-label="Cổng Tiện Ích">
          ...
          <div class="dock-tile-cr" data-nav="WALLET" role="button" tabindex="0">
            ...
            <p class="dock-desc">13 chính sách và đặc quyền đã được phân loại: Cổng chính thức và Kênh theo dõi. Nguồn gốc rõ ràng.</p>
    ...
    return `
      <div class="cr-experience-container" id="leisure-journey-root">
        ...
        <div style="background: var(--bg-card); padding: 20px; border-radius: var(--radius-md); border: 1px solid var(--border-color);">
          ...
          <p style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 16px;">
            Tra cứu lịch chiếu rạp phim CGV, Metiz, di sản văn hóa và các điểm ngắm cảnh ven sông Hàn có xác thực lịch hoạt động.
          </p>
  ...
  // 4. WALLET VIEW (SECTION DJ: FAIL-CLOSED OFFICIAL PORTALS)
    ...
    return `
      <article class="value-layer-card" data-lane="${entry.lane}" data-category="${entry.category}">
        ...
        <div class="official-value-layer-box">
          ...
          <div class="value-question-row">
            <span class="q-label">🌐 Cổng đối soát:</span>
            <p class="q-answer">${entry.official_portal_guide}</p>
          </div>
        </div>

        <div class="value-card-footer">
          <a href="${entry.official_source_url}" target="_blank" rel="noopener noreferrer" class="btn-value-action btn-action-source">
    ...
    return `
      <div class="cr-experience-container">
        ...
        <div style="background: var(--bg-card); padding: 20px; border-radius: var(--radius-md); border: 1px solid var(--border-color);">
          ...
          <p style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 16px;">
            13 chính sách học đường và đô thị đã phân loại: Cổng chính thức và Kênh theo dõi. Nguồn gốc rõ ràng, cập nhật định kỳ.
          </p>

          <div style="display: flex; gap: 8px; flex-wrap: wrap;">
            <button class="nav-btn ${activeWalletLane === 'ALL' ? 'active' : ''}" data-lane-filter="ALL">Tất cả (13)</button>
            ...
            <button class="nav-btn ${activeWalletLane === 'LANE_THEO_DOI' ? 'active' : ''}" data-lane-filter="LANE_THEO_DOI">📡 Kênh theo dõi (${theoDoiCount})</button>
          </div>
        </div>
  ...
  // 5. EXPLORE DIRECTORY VIEW (50 ITEMS STRICTLY CLASSIFIED: 0 T1, 20 T2, 18 T3, 12 T4)
  ...
  // 8. PROGRESSIVE DISCLOSURE DETAIL DRAWER (SECTION DJ)
  function openItemDrawer(itemId, triggerEl) {
    ...
    drawerRoot.innerHTML = `
      <div class="jayt-drawer-backdrop" id="drawer-backdrop">
        <div class="jayt-drawer-box" role="dialog" aria-modal="true" aria-labelledby="drawer-item-title">
          <div class="drawer-header">
            ...
            <button class="drawer-close-btn" id="btn-close-drawer" aria-label="Đóng bảng chi tiết">&times;</button>
          </div>
          ...
          <div class="drawer-body">
            ...
            <div class="drawer-section-card">
              <div class="drawer-section-title">🛡️ Căn Cứ Đối Soát & Tính Minh Bạch</div>
              <p style="font-size: 0.85rem; color: var(--text-secondary); line-height: 1.4;">
                • Nguồn chính thức: <a href="${item.official_source_url}" target="_blank" rel="noopener noreferrer" style="color: var(--teal-primary); font-weight: 600; word-break: break-all;">${hostname}</a><br>
                • Trạng thái: ${item.evidence_status}<br>
                • Cam kết bảo vệ người dùng: Không thu thập dữ liệu cá nhân (Zero-PII).
              </p>
            </div>
          </div>

          <div class="drawer-footer">
            <a href="${action.url}" target="_blank" rel="noopener noreferrer" class="btn-rail-action ${action.btnClass}" style="flex-grow: 1; text-align: center; justify-content: center; min-height: 44px;">
              ${action.label}
            </a>
            ${item.map_query_url ? `
              <a href="${item.map_query_url}" target="_blank" rel="noopener noreferrer" class="btn-rail-map" style="min-height: 44px; display: inline-flex; align-items: center;" title="Xem vị trí Maps">
                📍 Maps
              </a>
            ` : ''}
          </div>
    ...
    root.innerHTML = `
      <div class="jayt-app-shell theme-${currentTheme}">
          ...
          <div class="header-inner">
            <div class="brand-lockup" role="button" tabindex="0" data-nav="HOME" aria-label="Về trang chủ JayT">
              <svg width="28" height="28" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path d="M19 6 V19 C19 24.5 15.5 28 10 28 C6.5 28 4.2 26 3.5 24 C5.2 24 7 22.8 7.5 20.8 C8 18.5 6.5 16.5 4.5 16.5 C3.8 16.5 3 16.8 2.5 17.2 C3.5 10.5 11 6 19 6 Z" fill="url(#jflow-logo-grad-dj)"/>
                <path d="M19 14 C23.5 14 27.5 17 29.5 21 C31 24 32.5 28 33.5 31 C29.5 29 25 27.5 19 27.5 V21.5 C22 21.5 24.5 23 26 24.5 C24.5 20 20.5 17.5 16 17 L19 14 Z" fill="url(#jflow-logo-grad-dj)" opacity="0.9"/>
                <circle cx="27" cy="8" r="3.5" fill="#f43f5e"/>
                <defs>
                  <linearGradient id="jflow-logo-grad-dj" x1="4" y1="4" x2="34" y2="34" gradientUnits="userSpaceOnUse">
              ...
              <div class="brand-text-group">
                ...
                <span class="brand-tagline">Sống Hay Hơn Mỗi Ngày &bull; v3.438.0-staging.dj</span>
              </div>
            </div>
            ...
            <nav class="nav-links-desktop" role="navigation" aria-label="Điều hướng chính">
              ...
              <button class="nav-btn ${activeView === 'WALLET' ? 'active' : ''}" data-nav="WALLET">Ví Voucher (13)</button>
              <button class="nav-btn ${activeView === 'BUY_DECISION' ? 'active' : ''}" data-nav="BUY_DECISION">Có Hời Không?</button>
        ...
        <footer style="text-align: center; padding: 32px 16px; font-size: 0.8rem; color: var(--text-muted); border-top: 1px solid var(--border-color);" role="contentinfo">
          <div>JayT Đà Nẵng &bull; Chuẩn Bento Progressive DJ &bull; v3.438.0-staging.dj</div>
        </footer>
        ...
        <nav class="jayt-mobile-bottom-nav" role="navigation" aria-label="Điều hướng di động">
          ...
          <button class="mobile-nav-btn ${activeView === 'BUY_DECISION' ? 'active' : ''}" data-nav="BUY_DECISION">
            <span class="nav-icon">🛡️</span>
  ...
  // 11. INITIALIZATION & CLEAN HYDRATION
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
      JAYT_STOREFRONT_VERSION: 'v3.438.0-staging.dj',
