/**
 * JAYT COMMUNITY OS — SUPPLY LEDGER & VERIFIED DEALS (SECTION DF)
 * Release Candidate: v3.436.0-staging.df
 * Governing Directive: JAYT-245 Section DF (Lines 2591-2622)
 */
...
(function() {
  ...
  if (typeof window !== 'undefined' && window.JAYT_OBSERVABILITY) {
    window.JAYT_OBSERVABILITY.recordEvent('STOREFRONT_INITIALIZED', {
      version: 'v3.436.0-staging.df',
      environment: 'STAGING_REVIEW_DF',
      theme: 'SUPPLY_EVIDENCE_DF',
      dom_isolation: 'STRICT_ZERO_DOM_INJECTION'
    });
  }

  if (typeof window !== 'undefined') {
    window.JAYT_STOREFRONT_VERSION = 'v3.436.0-staging.df';
  }

  // 1. DATA LEDGER (50 SANITIZED HONEST TIERED ITEMS: 7 DEALS, 18 OFFICIAL, 15 UTILITIES, 10 RADARS)
  const JAYT_DISCOVERY_ITEMS = [
  {
    ...
    "title": "CGV Cinemas Đà Nẵng: Vé U22 Đồng Giá 55.000đ/Vé",
    "brand": "CGV Cinemas",
    "monogram": "CGV",
    "color_accent": "#e11d48",
    "category": "Giải trí",
    ...
    "evidence_status": "Đã đối soát biểu giá vé U22 niêm yết chính hãng (55k/vé 2D)",
    ...
    "deal_price": "55.000đ/vé",
    "original_price": "95.000đ/vé",
    "total_payable": "55.000đ",
    "savings_percent": "42%",
    "deal_cond": "Chương trình CGV U22 từ Thứ 2 đến Thứ 6 cho thành viên 12-22 tuổi hoặc xuất trình thẻ HSSV tại CGV Vĩnh Trung / Vincom Đà Nẵng.",
    "valid_until": "2026-12-31",
    "evidence_url": "https://www.cgv.vn",
    "evidence_time": "2026-08-29T22:00:00Z",
    "reviewer": "Council Data & Trust — Đối soát Chính sách giá vé U22 công bố trên cổng chính thức CGV Cinemas"
  },
  {
  ...
  },
  {
    ...
    "title": "Metiz Cinema Helio: Vé Member HSSV 45.000đ/Vé",
    "brand": "Metiz Cinema",
    "monogram": "MZ",
    "color_accent": "#0d9488",
    "category": "Giải trí",
    ...
    "evidence_status": "Đã đối soát biểu giá HSSV Metiz Helio (45k/vé 2D)",
    ...
    "tier_badge": "🔥 DEAL XÁC MINH",
    "tier_badge_class": "tier-badge-deal",
    "deal_price": "45.000đ/vé",
    "original_price": "80.000đ/vé",
    "total_payable": "45.000đ",
    "savings_percent": "44%",
    "deal_cond": "Áp dụng cho thẻ Metiz Member HSSV / U22 các ngày trong tuần tại Metiz Cinema Helio Center Đà Nẵng.",
    "valid_until": "2026-12-31",
    "evidence_url": "https://metiz.vn",
    "evidence_time": "2026-08-29T22:00:00Z",
    "reviewer": "Council Data & Trust — Đối soát Chính sách giá vé HSSV Metiz Cinema Đà Nẵng"
  },
  {
    ...
    "title": "GitHub Student Pack: Bộ Công Cụ Lập Trình Miễn Phí $200k+",
    ...
    "evidence_status": "Đã đối soát điều kiện kích hoạt miễn phí qua cổng GitHub Education",
    ...
    "specific_action_label": "📍 Chỉ đường Google Maps",
    "tier_level": "TIER_1_DEAL",
    "tier_badge": "🔥 ĐẶC QUYỀN 0Đ",
    "tier_badge_class": "tier-badge-deal",
    "deal_price": "0đ / Gói $200k+",
    "original_price": "4.800.000đ/năm",
    "total_payable": "0đ",
    "savings_percent": "100%",
    "deal_cond": "Dành cho sinh viên ĐH Bách Khoa, Sư Phạm Kỹ Thuật, Duy Tân, FPT... tại Đà Nẵng xác thực bằng email .edu.vn hoặc thẻ SV.",
    "valid_until": "2026-12-31",
    "evidence_url": "https://education.github.com/pack",
    "evidence_time": "2026-08-29T22:00:00Z",
    "reviewer": "Council Data & Trust — Đối soát Điều kiện GitHub Student Developer Pack toàn cầu"
  },
  {
    ...
    "tier_name": "Nguồn Cung Đã Đối Soát",
    "badge_label": "ĐẶC QUYỀN HỌC ĐƯỜNG",
    "title": "Notion for Education: Nâng Cấp Gói Plus Miễn Phí $96/Năm",
    "brand": "Notion",
    "monogram": "NT",
    "color_accent": "#000000",
    "category": "Học tập",
    ...
    "evidence_status": "Đã đối soát điều kiện nâng cấp Notion Plus 0đ chính thức",
    ...
    "tier_badge": "🔥 ĐẶC QUYỀN 0Đ",
    "tier_badge_class": "tier-badge-deal",
    "deal_price": "0đ / Gói Plus",
    "original_price": "2.400.000đ/năm",
    "total_payable": "0đ",
    "savings_percent": "100%",
    "deal_cond": "Tài khoản Notion Plus miễn phí trọn đời thời gian học cho sinh viên & giảng viên có email tên miền trường học.",
    "valid_until": "2026-12-31",
    "evidence_url": "https://www.notion.so/product/notion-for-education",
    "evidence_time": "2026-08-29T22:00:00Z",
    "reviewer": "Council Data & Trust — Đối soát Chính sách Notion for Education Plus Plan"
  },
  {
  ...
  },
  {
    ...
    "title": "DanaBus: Vé Tháng Trợ Giá HSSV 45.000đ/Tháng",
    ...
    "evidence_status": "Đã đối soát biểu giá trợ giá HĐND TP. Đà Nẵng (45k/tháng)",
    ...
    "tier_badge": "🔥 DEAL XÁC MINH",
    "tier_badge_class": "tier-badge-deal",
    "deal_price": "45.000đ/tháng",
    "original_price": "90.000đ/tháng",
    "total_payable": "45.000đ",
    "savings_percent": "50%",
    "deal_cond": "Áp dụng cho HSSV các trường ĐH/CĐ/THPT tại Đà Nẵng (xuất trình thẻ HSSV chính quy khi làm vé tháng).",
    "valid_until": "2026-12-31",
    "evidence_url": "https://danangbus.vn",
    "evidence_time": "2026-08-29T22:00:00Z",
    "reviewer": "Council Data & Trust — Đối soát Quyết định HĐND TP. Đà Nẵng về trợ giá xe buýt công cộng",
  ...
  },
  {
    ...
    "title": "Thư Viện KHTH Đà Nẵng: Không Gian Học Tập & Đọc Sách 0đ",
    ...
    "evidence_status": "Đã đối soát chính sách phục vụ miễn phí công dân",
    ...
    "tier_badge": "🔥 ĐẶC QUYỀN 0Đ",
    "tier_badge_class": "tier-badge-deal",
    "deal_price": "0đ / Miễn phí",
    "original_price": "50.000đ/năm",
    "total_payable": "0đ",
    "savings_percent": "100%",
    "deal_cond": "Đọc tại chỗ & không gian máy lạnh wifi miễn phí cho toàn bộ công dân & HSSV tại 46 Bạch Đằng.",
    "valid_until": "2026-12-31",
    "evidence_url": "https://danang.gov.vn",
    "evidence_time": "2026-08-29T22:00:00Z",
    "reviewer": "Council Data & Trust — Đối soát Quy chế phục vụ cộng đồng Thư viện KHTH Đà Nẵng",
  ...
  },
  {
    ...
    "title": "Bảo Tàng Điêu Khắc Chăm: Vé HSSV 10.000đ/Vé",
    ...
    "evidence_status": "Đã đối soát niêm yết HĐND TP. Đà Nẵng (10k/vé HSSV)",
    ...
    "tier_badge": "🔥 DEAL XÁC MINH",
    "tier_badge_class": "tier-badge-deal",
    "deal_price": "10.000đ/vé",
    "original_price": "60.000đ/vé",
    "total_payable": "10.000đ",
    "savings_percent": "83%",
    "deal_cond": "Áp dụng cho sinh viên & học sinh toàn quốc khi xuất trình thẻ còn hiệu lực tại quầy vé Bảo tàng Chăm Đà Nẵng.",
    "valid_until": "2026-12-31",
    "evidence_url": "http://chammuseum.vn",
    "evidence_time": "2026-08-29T22:00:00Z",
    "reviewer": "Council Data & Trust — Đối soát Niêm yết Nghị quyết phí tham quan danh lam thắng cảnh Đà Nẵng",
  ...
  function getCurrentTimeSlotInfo() {
    ...
    if (hour >= 5 && hour < 11) {
      return { slot: 'SLOT_MORNING', label: 'Sáng nay', momentTag: '🌅 BUỔI SÁNG &bull; ĐẶC QUYỀN ĐIỂM TÂM & CÀ PHÊ ĐÀ THÀNH', momentDesc: 'Khung giờ điểm tâm, cà phê ven sông và tuyến xe buýt DanaBus 45k/tháng.' };
    } else if (hour >= 11 && hour < 14) {
      return { slot: 'SLOT_LUNCH', label: 'Trưa nay', momentTag: '🍜 BUỔI TRƯA &bull; ƯU ĐÃI ẨM THỰC TIẾP SỨC ĐÀ NẴNG', momentDesc: 'Thực đơn trưa văn phòng, mì Quảng truyền thống và ẩm thực Hải Châu.' };
    } else if (hour >= 14 && hour < 18) {
      return { slot: 'SLOT_AFTERNOON', label: 'Chiều nay', momentTag: '☕ BUỔI CHIỀU &bull; VOUCHER TỰ HỌC & LÀM VIỆC VEN SÔNG', momentDesc: 'Không gian tự học Thư viện KHTH 0đ, gói công cụ GitHub/Notion 0đ cho HSSV.' };
    } else {
      return { slot: 'SLOT_EVENING', label: 'Tối nay', momentTag: '✨ BUỔI TỐI &bull; GIẢI TRÍ, RẠP PHIM & DẠO SÔNG HÀN', momentDesc: 'Vé xem phim CGV 55k, Metiz 45k, dạo mát Cầu Rồng và bảo tàng điêu khắc Chăm 10k.' };
    }
  }

  // RESOLVE HONEST ACTION CONTRACT (SECTION DF)
  ...
  function renderRailCard(item) {
    ...
    const isDeal = item.tier_level === 'TIER_1_DEAL';

    return `
      <article class="rail-card-cn ${isDeal ? 'rail-card-deal-verified' : ''}" data-item-id="${item.item_id}">
        ...
        <div class="rail-body">
          ...
          ${isDeal ? `
            <div class="deal-pricing-box" style="margin: 8px 0; padding: 8px 10px; background: #fff1f2; border-radius: 8px; border: 1px solid #fecdd3;">
              <div style="display: flex; align-items: baseline; gap: 8px;">
                <span style="font-size: 1.15rem; font-weight: 800; color: #e11d48;">${item.deal_price}</span>
                ${item.original_price ? `<s style="font-size: 0.8rem; color: #94a3b8;">${item.original_price}</s>` : ''}
                ${item.savings_percent ? `<span style="font-size: 0.72rem; font-weight: 700; background: #e11d48; color: #fff; padding: 2px 6px; border-radius: 4px;">-${item.savings_percent}</span>` : ''}
              </div>
              <div style="font-size: 0.78rem; color: #9f1239; margin-top: 4px; line-height: 1.35;">
                📋 <strong>Điều kiện:</strong> ${item.deal_cond}
              </div>
            </div>
          ` : ''}
          ...
          <div class="rail-evidence-line">✓ ${item.evidence_status}</div>
  ...
  // 1. MODERN BENTO COMMERCE HOME VIEW
  function renderDailyGuideHome() {
    const timeInfo = getCurrentTimeSlotInfo();
    const verifiedDeals = JAYT_DISCOVERY_ITEMS.filter(i => i.tier_level === 'TIER_1_DEAL');
    const hasT1 = verifiedDeals.length > 0;
    const dealRadarCards = hasT1 ? verifiedDeals.slice(0, 6) : JAYT_DISCOVERY_ITEMS.slice(0, 6);
      ...
      <div class="cr-experience-container">
          ...
          <section class="bento-tile-main-stage hero-landmark-cr vivid-dragon-hero-cf" aria-label="Bìa Đặc Quyền Đà Nẵng">
            ...
            <div class="bento-stage-content hero-landmark-content">
              ...
              <p class="hero-subhead-cr vivid-subhead">
                ${hasT1 
                  ? `Đặc quyền thật hôm nay: <strong>${verifiedDeals.length} ưu đãi đã đối soát giá thực</strong> (Vé xe buýt 45k, Vé bảo tàng 10k, Vé xem phim 45k-55k, Công cụ học tập 0đ).` 
              ...
              <div class="hero-shopping-actions-grid">
                <button class="btn-hero-deal-action btn-primary-action-cf" data-nav="EXPLORE" data-tier-filter="TIER_1_DEAL">
                  ${hasT1 ? `🔥 Deal dùng hôm nay (${verifiedDeals.length}) &rarr;` : '🏛️ Xem ưu đãi & cổng đang kiểm &rarr;'}
                </button>
        ...
        <section id="featured-deals-section" aria-label="Deal Radar Hôm Nay">
          <div class="section-flow-header">
            <div>
              <h2 class="section-flow-title">🔥 Deal Xác Minh & Ưu Đãi Hôm Nay (${verifiedDeals.length})</h2>
              <p class="section-flow-subtitle">Các chương trình ưu đãi thực tế đã đối soát giá niêm yết, tổng tiền phải trả và điều kiện áp dụng.</p>
            </div>
            <button class="section-flow-viewall" data-nav="EXPLORE" data-tier-filter="TIER_1_DEAL">
              Xem tất cả ${verifiedDeals.length} Deal &rarr;
            </button>
          </div>
          ...
          <div class="moments-grid-cw">
            ...
            <article class="moment-card-cw spotlight-visual-stage-cn" id="journey-transport">
              ...
              <div class="moment-content-box">
                ...
                <p class="moment-desc">Vé tháng HSSV trợ giá 45.000đ/tháng kết nối liên quận trên toàn TP. Đà Nẵng.</p>
                <div class="moment-actions">
            ...
            <article class="moment-card-cw spotlight-visual-stage-cn" id="journey-study">
              ...
              <div class="moment-content-box">
                ...
                <p class="moment-desc">Đặc quyền 0đ đọc sách tại chỗ, phòng máy lạnh và wifi miễn phí cho độc giả Đà Nẵng.</p>
                <div class="moment-actions">
            ...
            <article class="moment-card-cw spotlight-visual-stage-cn" id="journey-leisure">
              ...
              <div class="moment-content-box">
                ...
                <p class="moment-desc">Vé tham quan sinh viên 10.000đ/vé ngay đầu Cầu Rồng và dạo mát phố đi bộ về đêm.</p>
                <div class="moment-actions">
    ...
    return `
      <div class="cr-experience-container" id="leisure-journey-root">
        ...
        <div style="background: var(--bg-card); padding: 20px; border-radius: var(--radius-md); border: 1px solid var(--border-color);">
          ...
          <p style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 16px;">
            Tra cứu lịch chiếu rạp phim CGV (55k), Metiz (45k), di sản văn hóa và các điểm ngắm cảnh ven sông Hàn có xác thực lịch hoạt động.
          </p>
    ...
    return `
      <div class="cr-experience-container">
        ...
        <div style="background: var(--bg-card); padding: 20px; border-radius: var(--radius-md); border: 1px solid var(--border-color);">
          ...
          <p style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 16px;">
            Bộ sưu tập 50 tiện ích, cổng chính thức và ${tier1Count} deal xác minh giá thực tại TP. Đà Nẵng.
          </p>
        ...
        ${filtered.length > 0 
          ...
          : `
            <div style="text-align: center; padding: 48px 16px; background: var(--bg-card); border-radius: var(--radius-md); border: 1px solid var(--border-color);">
              ...
              <h3>Không tìm thấy mục phù hợp</h3>
              <p style="color: var(--text-muted); font-size: 0.9rem; margin-top: 4px;">
                Vui lòng chọn bộ lọc khác để khám phá các tiện ích và cổng chính thức tại Đà Nẵng.
              </p>
            </div>
          `
        }
    ...
    root.innerHTML = `
      <div class="jayt-app-shell theme-${currentTheme}">
          ...
          <div class="header-inner">
            <div class="brand-lockup" role="button" tabindex="0" data-nav="HOME" aria-label="Về trang chủ JayT">
              <svg width="28" height="28" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path d="M19 6 V19 C19 24.5 15.5 28 10 28 C6.5 28 4.2 26 3.5 24 C5.2 24 7 22.8 7.5 20.8 C8 18.5 6.5 16.5 4.5 16.5 C3.8 16.5 3 16.8 2.5 17.2 C3.5 10.5 11 6 19 6 Z" fill="url(#jflow-logo-grad-df)"/>
                <path d="M19 14 C23.5 14 27.5 17 29.5 21 C31 24 32.5 28 33.5 31 C29.5 29 25 27.5 19 27.5 V21.5 C22 21.5 24.5 23 26 24.5 C24.5 20 20.5 17.5 16 17 L19 14 Z" fill="url(#jflow-logo-grad-df)" opacity="0.9"/>
                <circle cx="27" cy="8" r="3.5" fill="#f43f5e"/>
                <defs>
                  <linearGradient id="jflow-logo-grad-df" x1="4" y1="4" x2="34" y2="34" gradientUnits="userSpaceOnUse">
              ...
              <div class="brand-text-group">
                ...
                <span class="brand-tagline">Sống Hay Hơn Mỗi Ngày &bull; v3.436.0-staging.df</span>
              </div>
            </div>
            ...
            <nav class="nav-links-desktop" role="navigation" aria-label="Điều hướng chính">
              ...
              <button class="nav-btn ${activeView === 'WALLET' ? 'active' : ''}" data-nav="WALLET">Ví Voucher (3 Làn)</button>
        ...
        <footer style="text-align: center; padding: 32px 16px; font-size: 0.8rem; color: var(--text-muted); border-top: 1px solid var(--border-color);" role="contentinfo">
          <div>JayT Đà Nẵng &bull; Chuẩn Supply Evidence DF &bull; v3.436.0-staging.df</div>
        </footer>
  ...
  function attachBuyDecisionEvents() {
    ...
    if (submitBtn && input && resultBox) {
      submitBtn.onclick = () => {
        ...
        const match = JAYT_DISCOVERY_ITEMS.find(i => i.title.toLowerCase().includes(val.toLowerCase()) || i.brand.toLowerCase().includes(val.toLowerCase()));

        resultBox.style.display = 'block';
        if (match && match.tier_level === 'TIER_1_DEAL') {
          resultBox.innerHTML = `
            <div style="font-size: 0.95rem; font-weight: 700; color: #059669; margin-bottom: 8px;">
              ✓ Đã có dữ liệu đối soát: ${match.title}
            </div>
            <div style="font-size: 0.85rem; color: var(--text-secondary); line-height: 1.5;">
              • Giá thực: <strong>${match.deal_price}</strong> ${match.original_price ? `(Gốc: ${match.original_price})` : ''}<br>
              • Tiết kiệm: ${match.savings_percent || 'Ưu đãi chính thức'}<br>
              • Điều kiện: ${match.deal_cond}<br>
              • Đánh giá: <strong>NÊN MUA / SỬ DỤNG</strong> theo điều kiện HSSV.
            </div>
          `;
        } else {
          resultBox.innerHTML = `
            ...
            <div style="font-size: 0.85rem; color: var(--text-secondary); line-height: 1.5;">
              • Món đồ/dịch vụ "<strong>${val}</strong>" chưa có trong danh mục đối soát T1.<br>
              • Khuyến nghị: Kiểm tra trực tiếp hóa đơn và phụ phí trước khi thanh toán tại cửa hàng.
            </div>
          `;
        }
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
      JAYT_STOREFRONT_VERSION: 'v3.436.0-staging.df',
