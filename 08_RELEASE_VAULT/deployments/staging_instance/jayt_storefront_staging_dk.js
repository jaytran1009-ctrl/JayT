/**
 * JAYT COMMUNITY OS — TOUCH TARGET AA & ACCESSIBLE PROVENANCE (SECTION DK)
 * Release Candidate: v3.439.0-staging.dk
 * Governing Directive: JAYT-245 Section DK (Lines 2725-2744)
 */
...
(function() {
  ...
  if (typeof window !== 'undefined' && window.JAYT_OBSERVABILITY) {
    window.JAYT_OBSERVABILITY.recordEvent('STOREFRONT_INITIALIZED', {
      version: 'v3.439.0-staging.dk',
      environment: 'STAGING_REVIEW_DK',
      theme: 'ACCESSIBLE_BENTO_DK',
      dom_isolation: 'STRICT_ZERO_DOM_INJECTION'
    });
  }

  if (typeof window !== 'undefined') {
    window.JAYT_STOREFRONT_VERSION = 'v3.439.0-staging.dk';
  }
  ...
  // RENDER CARD WITH PROGRESSIVE DISCLOSURE & TOUCH TARGET $ge 44$px
    ...
    return `
      <article class="rail-card-cn" data-item-id="${item.item_id}">
        ...
        <div class="rail-footer-actions-row">
          ...
          ${item.map_query_url ? `
            <a href="${item.map_query_url}" target="_blank" rel="noopener noreferrer" class="btn-rail-map" aria-label="Xem vị trí ${item.title} trên Google Maps" title="Xem bản đồ Maps">
              📍 Maps
            </a>
          ` : ''}
        </div>
    ...
    return `
      <div class="cr-experience-container">
        ...
        <div class="bento-hero-grid" aria-label="Bảng Điều Khiển Bento Đà Nẵng">
          ...
          <section class="bento-tile-main-stage hero-landmark-cr vivid-dragon-hero-cf" aria-label="Bìa Đặc Quyền Đà Nẵng">
            ...
            <div class="bento-stage-content hero-landmark-content">
              ...
              <!-- HERO DECISION HIERARCHY (SECTION DK: MIN 44px TOUCH TARGETS) -->
              <div class="hero-shopping-actions-grid">
                <button class="btn-hero-primary-solid" data-nav="EXPLORE" data-tier-filter="TIER_2_PROGRAMME" aria-label="Xem ưu đãi và cổng thông tin đang kiểm">
                  🏛️ Xem ưu đãi & cổng đang kiểm &rarr;
                </button>
                <button class="btn-hero-secondary-outline" data-nav="WALLET" aria-label="Mở ví voucher chính thức 13 chính sách">
                  🎟️ Ví Voucher (13) &rarr;
                </button>
                <button class="btn-hero-tertiary-ghost" data-nav="BUY_DECISION" aria-label="Kiểm tra trạng thái đối soát giá trước khi mua">
          ...
          <div class="bento-side-column">
            ...
            <div class="bento-tile-dock">
              ...
              <div class="bento-dock-row">
                <button class="bento-dock-btn" data-nav="WALLET" aria-label="Mở ví voucher 13 mục">
        ...
        <section class="civic-ticker-cr hero-civic-note-cf" role="region" aria-label="Điểm Nhấn Đô Thị Hôm Nay">
          ...
          <a href="https://danang.gov.vn" target="_blank" rel="noopener noreferrer" class="civic-ticker-link" aria-label="Xem cổng thông tin danang.gov.vn">
            danang.gov.vn &rarr;
          </a>
        </section>
        ...
        <!-- 4. RAIL 2: VOUCHER QUYỀN LỢI (SECTION DK: FAIL-CLOSED COPY) -->
        <section aria-label="Ví Voucher Đặc Quyền Học Đường">
          <div class="section-flow-header">
            ...
            <button class="section-flow-viewall" data-nav="WALLET" aria-label="Mở toàn bộ ví voucher">
              Mở toàn bộ ví &rarr;
            </button>
          </div>
          ...
          <div class="moments-grid-cw">
            <article class="moment-card-cw spotlight-visual-stage-cn" id="journey-food">
              ...
              <div class="moment-content-box">
                ...
                <div class="moment-actions">
                  <a href="https://www.google.com/maps/search/?api=1&query=Ph%E1%BB%91%20Hu%E1%BB%B3nh%20Th%C3%BAc%20Kh%C3%A1ng%20%C4%90%C3%A0%20N%E1%BA%B5ng" target="_blank" rel="noopener noreferrer" class="btn-rail-action" aria-label="Xem vị trí Phố Huỳnh Thúc Kháng trên Google Maps">
                    📍 Maps &rarr;
                  </a>
                </div>
              </div>
            ...
            <article class="moment-card-cw spotlight-visual-stage-cn" id="journey-transport">
              ...
              <div class="moment-content-box">
                ...
                <div class="moment-actions">
                  <a href="https://danangbus.vn" target="_blank" rel="noopener noreferrer" class="btn-rail-action" aria-label="Mở trang chủ Xe buýt DanaBus">
                    🚌 Tuyến Buýt &rarr;
                  </a>
                </div>
              </div>
            ...
            <article class="moment-card-cw spotlight-visual-stage-cn" id="journey-study">
              ...
              <div class="moment-content-box">
                ...
                <div class="moment-actions">
                  <a href="https://danang.gov.vn" target="_blank" rel="noopener noreferrer" class="btn-rail-action" aria-label="Xem nội quy Thư viện KHTH Đà Nẵng">
                    📚 Xem nội quy &rarr;
                  </a>
                </div>
              </div>
            ...
            <article class="moment-card-cw spotlight-visual-stage-cn" id="journey-leisure">
              ...
              <div class="moment-content-box">
                ...
                <div class="moment-actions">
                  <a href="http://chammuseum.vn" target="_blank" rel="noopener noreferrer" class="btn-rail-action" aria-label="Mở trang chủ Bảo tàng Điêu khắc Chăm">
                    🏛️ Tham quan &rarr;
                  </a>
                </div>
              </div>
        ...
        <section class="dock-tiles-grid-cr" aria-label="Cổng Tiện Ích">
          <div class="dock-tile-cr" data-nav="BUY_DECISION" role="button" tabindex="0" aria-label="Tra cứu Mua món này có hời không">
          ...
          <div class="dock-tile-cr" data-nav="WALLET" role="button" tabindex="0" aria-label="Mở ví quyền lợi học đường">
  ...
  // 4. WALLET VIEW (SECTION DK: FAIL-CLOSED PROVENANCE COPY)
      ...
      <div class="cr-experience-container">
        ...
        <div style="background: var(--bg-card); padding: 20px; border-radius: var(--radius-md); border: 1px solid var(--border-color);">
          ...
          <div style="display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 12px;">
            ...
            <button class="nav-btn ${activeTier === 'TIER_3_UTILITY' ? 'active' : ''}" data-exp-tier="TIER_3_UTILITY" aria-label="Tiện ích xác minh">📍 Tiện ích xác minh (${tier3Count})</button>
  ...
  // 8. PROGRESSIVE DISCLOSURE DETAIL DRAWER WITH FOCUS TRAP (SECTION DK)
  function openItemDrawer(itemId, triggerEl) {
      ...
      <div class="jayt-drawer-backdrop" id="drawer-backdrop">
        <div class="jayt-drawer-box" role="dialog" aria-modal="true" aria-labelledby="drawer-item-title" aria-describedby="drawer-item-desc">
          ...
          <div class="drawer-body" id="drawer-item-desc">
            ...
            <div class="drawer-section-card">
              <div class="drawer-section-title">🛡️ Căn Cứ Nguồn & Tính Minh Bạch</div>
              <p style="font-size: 0.85rem; color: var(--text-secondary); line-height: 1.4;">
                • Nguồn chính thức: <a href="${item.official_source_url}" target="_blank" rel="noopener noreferrer" style="color: var(--teal-primary); font-weight: 600; word-break: break-all;" aria-label="Mở trang chính thức của ${hostname}">${hostname}</a><br>
                • Phân loại: ${item.evidence_status}<br>
    ...
    const focusableEls = drawerRoot.querySelectorAll('button, a, input, [tabindex="0"]');
    ...
    root.innerHTML = `
      <div class="jayt-app-shell theme-${currentTheme}">
          ...
          <div class="header-inner">
            <div class="brand-lockup" role="button" tabindex="0" data-nav="HOME" aria-label="Về trang chủ JayT Đà Nẵng">
              <svg width="28" height="28" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path d="M19 6 V19 C19 24.5 15.5 28 10 28 C6.5 28 4.2 26 3.5 24 C5.2 24 7 22.8 7.5 20.8 C8 18.5 6.5 16.5 4.5 16.5 C3.8 16.5 3 16.8 2.5 17.2 C3.5 10.5 11 6 19 6 Z" fill="url(#jflow-logo-grad-dk)"/>
                <path d="M19 14 C23.5 14 27.5 17 29.5 21 C31 24 32.5 28 33.5 31 C29.5 29 25 27.5 19 27.5 V21.5 C22 21.5 24.5 23 26 24.5 C24.5 20 20.5 17.5 16 17 L19 14 Z" fill="url(#jflow-logo-grad-dk)" opacity="0.9"/>
                <circle cx="27" cy="8" r="3.5" fill="#f43f5e"/>
                <defs>
                  <linearGradient id="jflow-logo-grad-dk" x1="4" y1="4" x2="34" y2="34" gradientUnits="userSpaceOnUse">
              ...
              <div class="brand-text-group">
                ...
                <span class="brand-tagline">Sống Hay Hơn Mỗi Ngày &bull; v3.439.0-staging.dk</span>
              </div>
            </div>
            ...
            <nav class="nav-links-desktop" role="navigation" aria-label="Điều hướng chính">
              ...
              <button class="nav-btn ${activeView === 'WALLET' ? 'active' : ''}" data-nav="WALLET" aria-label="Mở ví voucher 13 mục">Ví Voucher (13)</button>
        ...
        <footer style="text-align: center; padding: 32px 16px; font-size: 0.8rem; color: var(--text-muted); border-top: 1px solid var(--border-color);" role="contentinfo">
          <div>JayT Đà Nẵng &bull; Chuẩn Bento Touch AA DK &bull; v3.439.0-staging.dk</div>
        </footer>
        ...
        <nav class="jayt-mobile-bottom-nav" role="navigation" aria-label="Điều hướng di động">
          ...
          <button class="mobile-nav-btn ${activeView === 'WALLET' ? 'active' : ''}" data-nav="WALLET" aria-label="Trang Ví Voucher">
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
      JAYT_STOREFRONT_VERSION: 'v3.439.0-staging.dk',
