/**
 * JAYT RELEASE CANDIDATE EMITTER (093)
...
const targetRcPath = path.join(repoRoot, '08_RELEASE_VAULT', 'RELEASE_CANDIDATE_093.json');
...
console.log(`✅ [RC-093-EMITTED] Đã tạo thành công Release Candidate 093: ${targetRcPath}`);
