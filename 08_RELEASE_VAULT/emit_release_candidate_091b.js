/**
 * JAYT RELEASE CANDIDATE EMITTER (091B)
 ...
 * Fail-closed: Refuses to overwrite unless explicitly specified.
 */
...
const targetRcPath = path.join(repoRoot, '08_RELEASE_VAULT', 'RELEASE_CANDIDATE_091B.json');
...
console.log(`✅ [RC-EMITTED] Đã tạo thành công Release Candidate 091B: ${targetRcPath}`);
