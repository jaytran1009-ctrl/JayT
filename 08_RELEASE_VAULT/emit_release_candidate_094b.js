...
const rcPath = path.resolve(__dirname, 'RELEASE_CANDIDATE_094B.json');

// FAIL-CLOSED: Append-Only Immutable Protocol
if (fs.existsSync(rcPath)) {
  console.error(`❌ [FAIL-CLOSED] RELEASE_CANDIDATE_094B.json đã tồn tại trên đĩa. Ghi đè bị cấm tuyệt đối theo chuẩn Append-Only!`);
  process.exit(1);
}
...
const candidateData = {
  release_candidate_id: 'JAYT_RELEASE_CANDIDATE_094B',
  version: '2.4.2',
  created_at: new Date().toISOString(),
  directive: 'JAYT-094B-STAGING-ABSOLUTE-LINEAGE-AND-UNCLAIMED-PREMIUM-BENTO',
  bundle_type: 'CINEMATIC_BENTO_DISCOVERY_STAGING_V4_2',
  status: 'EMITTED_PENDING_CEO_REVIEW',
  incident_disclosures: [
    '08_RELEASE_VAULT/DISCLOSURE_RECORD_094_RE_EMISSION_INTEGRITY_GAP.json',
    '08_RELEASE_VAULT/DISCLOSURE_RECORD_094A_RE_EMISSION_INTEGRITY_GAP.json'
  ],
  artifacts: artifacts,
  invariants: {
    ...
    zero_unverified_claims_across_entire_dom: true,
...
console.log(`✅ [EMIT-094B] Đã phát hành thành công Release Candidate 094B (Version 2.4.2): ${rcPath}`);
