...
(function(root) {
  ...
  {
    "card_id": "P2O_GALAXY_MEMBER_2026",
    "sku_id": "P2O_GALAXY_MEMBER_2026",
    ...
    "commercial_surface": "BRAND_PROGRAM",
    "voucher_tier": "BRAND_PROGRAM",
    "validity": "Đến hết 31/12/2026; điều kiện thành viên và quy đổi điểm theo trang chính thức.",
    "conditions": "Cần tài khoản thành viên; quyền lợi sinh nhật và đổi điểm có điều kiện áp dụng.",
    "captured_at": "2026-09-07T09:24:58.273Z",
    "geographic_scope": {
      "da_nang_applicable": "VERIFIED",
      "verification_basis": "INHERITED_BRAND_PRESENCE_OR_DIRECT_OFFER_LOCALITY",
      "scope_note": "Galaxy Cinema có cơ sở đã đối soát tại Đà Nẵng; không suy diễn suất chiếu, ghế hoặc tồn kho."
    },
    "disclaimer": "Thông tin đối soát tại thời điểm thu thập; ưu đãi chỉ áp dụng cho điều kiện, model và tồn kho được nguồn chính thức công bố.",
    "affiliate_url": null,
    "provenance": {
      "raw_file": "06_TRUST_AND_EVIDENCE/batch_15_p2_vault/run_20260907092151_b36bd8/P2O_GALAXY_MEMBER_2026.raw.html",
      "headers_file": "06_TRUST_AND_EVIDENCE/batch_15_p2_vault/run_20260907092151_b36bd8/P2O_GALAXY_MEMBER_2026.headers.json",
      "raw_sha256": "730168e05b69286624195aefae03d13383f1ab159767852a1f652312c99bff8b",
      "source_raw_sha256": "730168e05b69286624195aefae03d13383f1ab159767852a1f652312c99bff8b",
      "captured_at_utc": "2026-09-07T09:24:58.273Z",
      "final_url": "https://www.galaxycine.vn/khuyen-mai/uu-dai-thanh-vien-galaxy-cinema-2026/"
    },
    "claims_audit": {
      "cheapest_claim": false,
      "stock_guaranteed": false,
  ...
  {
    "card_id": "P2O_GALAXY_SHOPEEPAY_SEP_2026",
    "sku_id": "P2O_GALAXY_SHOPEEPAY_SEP_2026",
    "type": "LOCAL_OFFER_PROGRAM",
    "brand_id": "galaxy_cinema",
    "brand_name": "Galaxy Cinema x ShopeePay",
    ...
    "commercial_surface": "APP_VOUCHER",
    "voucher_tier": "APP_HIDDEN_CODE",
    "validity": "01/09/2026–30/09/2026 hoặc kết thúc sớm khi hết ngân sách.",
    "conditions": "Phải đăng nhập ứng dụng ShopeePay và tự claim voucher chính thức; JayT không phát hành hoặc hiển thị mã giả.",
    "captured_at": "2026-09-07T09:24:59.446Z",
    "geographic_scope": {
      "da_nang_applicable": "VERIFIED",
      "verification_basis": "INHERITED_BRAND_PRESENCE_OR_DIRECT_OFFER_LOCALITY",
      "scope_note": "Kế thừa bằng chứng Galaxy Cinema có cơ sở tại Đà Nẵng; quyền nhận voucher phụ thuộc ứng dụng và ngân sách."
    },
    "disclaimer": "Voucher phải được nhận trực tiếp trong ứng dụng ShopeePay chính thức, có thể hết ngân sách trước hạn. JayT không phát hành mã và không bảo đảm khả dụng.",
    "affiliate_url": null,
    "provenance": {
      "raw_file": "06_TRUST_AND_EVIDENCE/batch_15_p2_vault/run_20260907092151_b36bd8/P2O_GALAXY_SHOPEEPAY_SEP_2026.raw.html",
      "headers_file": "06_TRUST_AND_EVIDENCE/batch_15_p2_vault/run_20260907092151_b36bd8/P2O_GALAXY_SHOPEEPAY_SEP_2026.headers.json",
      "raw_sha256": "9037998cc5093d17bce4fa3b173b8f1129e9a72454185f99036b7413182b3966",
      "source_raw_sha256": "9037998cc5093d17bce4fa3b173b8f1129e9a72454185f99036b7413182b3966",
      "captured_at_utc": "2026-09-07T09:24:59.446Z",
      "final_url": "https://www.galaxycine.vn/khuyen-mai/voucher-giam-khung-danh-tang-cac-stars/"
    },
    "claims_audit": {
      "cheapest_claim": false,
      "stock_guaranteed": false,
  ...
  {
    "card_id": "P2O_PHILONG_LENOVO_STUDENT_2026",
    "sku_id": "P2O_PHILONG_LENOVO_STUDENT_2026",
    "type": "LOCAL_OFFER_PROGRAM",
    "brand_id": "phi_long",
    "brand_name": "Phi Long x Lenovo",
    "title": "Ưu đãi học sinh, sinh viên Lenovo 2026 tại Phi Long",
    "source_url": "https://philong.com.vn/lap-xin-qua-slay-cung-lenovo.html",
    "commercial_surface": "VALUE_RADAR",
    "voucher_tier": "VALUE_RADAR",
    "validity": "26/08/2026–31/10/2026 hoặc đến khi hết quà.",
    "conditions": "Chỉ áp dụng cho các model Lenovo được liệt kê trên trang nguồn; quà tặng tùy model và tồn kho.",
    "captured_at": "2026-09-07T09:21:53.191Z",
    "geographic_scope": {
      "da_nang_applicable": "VERIFIED",
      "verification_basis": "INHERITED_BRAND_PRESENCE_OR_DIRECT_OFFER_LOCALITY",
      "scope_note": "Trang ưu đãi nêu trực tiếp hai showroom Phi Long tại Đà Nẵng; không cam kết tồn kho từng model."
    },
    "disclaimer": "Thông tin đối soát tại thời điểm thu thập; ưu đãi chỉ áp dụng cho điều kiện, model và tồn kho được nguồn chính thức công bố.",
    "affiliate_url": null,
    "provenance": {
      "raw_file": "06_TRUST_AND_EVIDENCE/batch_15_p2_vault/run_20260907092151_b36bd8/P2O_PHILONG_LENOVO_STUDENT_2026.raw.html",
      "headers_file": "06_TRUST_AND_EVIDENCE/batch_15_p2_vault/run_20260907092151_b36bd8/P2O_PHILONG_LENOVO_STUDENT_2026.headers.json",
      "raw_sha256": "b4475c7d43592284e31ea2992bcb1ac50a45589704566bd7429981946adbf070",
      "source_raw_sha256": "b4475c7d43592284e31ea2992bcb1ac50a45589704566bd7429981946adbf070",
      "captured_at_utc": "2026-09-07T09:21:53.191Z",
      "final_url": "https://philong.com.vn/lap-xin-qua-slay-cung-lenovo.html"
    },
    "claims_audit": {
      "cheapest_claim": false,
      "stock_guaranteed": false,
  ...
  {
    "card_id": "P2O_PHILONG_HP_BTS_2026",
    "sku_id": "P2O_PHILONG_HP_BTS_2026",
    "type": "LOCAL_OFFER_PROGRAM",
    "brand_id": "phi_long",
    "brand_name": "Phi Long x HP",
    "title": "HP Back to School 2026 tại Phi Long",
    "source_url": "https://philong.com.vn/uu-dai-hp-back-to-school-2026.html",
    "commercial_surface": "VALUE_RADAR",
    "voucher_tier": "VALUE_RADAR",
    "validity": "01/08/2026–31/10/2026.",
    "conditions": "Chỉ áp dụng cho danh mục model HP OmniBook/HP Victus và các model được liệt kê; điều kiện kích hoạt phần mềm theo bên cung cấp.",
    "captured_at": "2026-09-07T09:21:53.472Z",
    "geographic_scope": {
      "da_nang_applicable": "VERIFIED",
      "verification_basis": "INHERITED_BRAND_PRESENCE_OR_DIRECT_OFFER_LOCALITY",
      "scope_note": "Kế thừa bằng chứng Phi Long có hai showroom tại Đà Nẵng; không suy diễn tồn kho từng model."
    },
    "disclaimer": "Thông tin đối soát tại thời điểm thu thập; ưu đãi chỉ áp dụng cho điều kiện, model và tồn kho được nguồn chính thức công bố.",
    "affiliate_url": null,
    "provenance": {
      "raw_file": "06_TRUST_AND_EVIDENCE/batch_15_p2_vault/run_20260907092151_b36bd8/P2O_PHILONG_HP_BTS_2026.raw.html",
      "headers_file": "06_TRUST_AND_EVIDENCE/batch_15_p2_vault/run_20260907092151_b36bd8/P2O_PHILONG_HP_BTS_2026.headers.json",
      "raw_sha256": "7e9a01faa73b42bd4012e939b315d037d74a4c9e45dd5c08c509d0a12ad81696",
      "source_raw_sha256": "7e9a01faa73b42bd4012e939b315d037d74a4c9e45dd5c08c509d0a12ad81696",
      "captured_at_utc": "2026-09-07T09:21:53.472Z",
      "final_url": "https://philong.com.vn/uu-dai-hp-back-to-school-2026.html"
    },
    "claims_audit": {
      "cheapest_claim": false,
      "stock_guaranteed": false,
  ...
  function renderVoucherHub() {
    ...
    return `
      <div class="cr-experience-container">
        <header style="margin: 20px 0 10px 0;">
          <h1 style="font-size: 1.5rem; font-weight: 800; color: var(--text-primary); margin-bottom: 6px;">
            🎟️ Kho Ưu Đãi &amp; Voucher Đà Nẵng (27 mục đối soát)
          </h1>
        ...
        <section class="commercial-control" aria-labelledby="voucher-title">
          ...
          <div class="tier-list" role="group" aria-label="Lọc tầng ưu đãi">
            <button class="tier-filter" data-commercial-filter="ALL" aria-pressed="true">Tất cả <span data-count="ALL">27</span></button>
            ...
            <button class="tier-filter tier-brand" data-commercial-filter="BRAND_PROGRAM" aria-pressed="false">🔵 Mã/Quyền lợi thương hiệu <span data-count="BRAND_PROGRAM">2</span></button>
            <button class="tier-filter tier-hidden" data-commercial-filter="APP_HIDDEN_CODE" aria-pressed="false">🟣 Voucher app/mã ẩn <span data-count="APP_HIDDEN_CODE">1</span></button>
            <button class="tier-filter tier-radar" data-commercial-filter="VALUE_RADAR" aria-pressed="false">📡 Radar thiết yếu <span data-count="VALUE_RADAR">15</span></button>
          </div>
          <p class="empty-tier-note" id="commercial-tier-status" role="status" style="margin-top: 10px; font-size: 13px; color: var(--text-muted);">
            Đang hiển thị 27 thẻ thương mại đã xác minh địa bàn Đà Nẵng.
          </p>
        </section>
        ...
        <section aria-labelledby="commercial-catalog-heading" style="margin-top: 20px;">
          ...
          <div id="v3424-commercial-container" class="commercial-grid" role="feed" aria-labelledby="commercial-catalog-heading">
  ...
  function mountCommercialCardsIntoVoucherHub() {
    const container = document.getElementById('v3424-commercial-container');
    if (!container) return;
    ...
    document.querySelectorAll('[data-commercial-filter]').forEach(button => {
      button.addEventListener('click', () => {
        ...
        let visibleCount = 0;
        document.querySelectorAll('#v3424-commercial-container .commercial-card').forEach(card => {
