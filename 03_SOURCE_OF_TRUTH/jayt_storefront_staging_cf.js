/**
 * JAYT COMMUNITY OS — LOCAL EDITORIAL DEPTH & OUTCOME ACTIONS (SECTION CF)
 * Release Candidate: v3.427.0-staging.cf
 * Governing Directive: JAYT-245 Section CF (Lines 2019-2043)
 * Key Architecture:
 *  - Vivid Panoramic Hero (Cầu Rồng Center Stage, Light Non-Intrusive Scrim)
 *  - Narrative Modules Replacing Card Walls with Varied Hierarchy
 *  - 4 Visual Archetypes: Verified Place, Official Programme, Radar, Voucher Ready
 *  - Differentiated Concrete Outcome Actions (Chỉ đường, Xem lịch, Điểm làm vé)
 *  - 3 Closed-Loop Action Journeys (Ăn gì, Đi đâu tối nay, Ví quyền lợi)
...
if (typeof window !== 'undefined' && window.JAYT_OBSERVABILITY) {
  window.JAYT_OBSERVABILITY.recordEvent('STOREFRONT_INITIALIZED', {
    version: 'v3.427.0-staging.cf',
    environment: 'STAGING_REVIEW_CF',
    dom_isolation: 'STRICT_ZERO_DOM_INJECTION'
  });
}

const JAYT_STOREFRONT_VERSION = 'v3.427.0-staging.cf';
...
// RESOLVE OUTCOME-DRIVEN ACTION CONTRACT (CF MANDATE #5)
...
// Render Archetype-Driven Primary Spotlight Card (CF Mandate #4)
  ...
  return `
    <article class="primary-archetype-card archetype-${item.visual_archetype.toLowerCase()}" data-item-id="${item.item_id}">
      <div class="card-kicker-strip">
        <span class="archetype-badge">${kickerText || item.badge_label}</span>
  ...
  return `
    <article class="compact-editorial-card archetype-${item.visual_archetype.toLowerCase()}" data-item-id="${item.item_id}">
      ...
      <div class="compact-body">
        ...
        <p class="compact-desc">${item.summary_text}</p>
...
function renderDailyGuideHome() {
  ...
  return `
    <div class="home-editorial-layout-cf">
      <!-- 1. VIVID DRAGON BRIDGE HERO FIRST FOLD (CF MANDATE #3) -->
      ...
      <!-- 3. TRUE NARRATIVE MODULE 1: ẨM THỰC ĐÀ THÀNH (CF MANDATE #2) -->
      <section class="narrative-journey-module" id="journey-food" aria-label="Hành Trình Ẩm Thực">
        ...
        <div class="narrative-grid-layout">
          <div class="narrative-spotlight-col">
            ${renderPrimarySpotlightCard(huynhThucKhang, '⭐ ĐỀ XUẤT ĐẶC SẮC')}
          </div>
      ...
      <!-- 4. TRUE NARRATIVE MODULE 2: DI CHUYỂN & GIAO THÔNG XANH (CF MANDATE #2) -->
      ...
      <!-- 5. TRUE NARRATIVE MODULE 3: HỌC TẬP & LÀM VIỆC (CF MANDATE #2) -->
      <section class="narrative-journey-module" id="journey-study" aria-label="Hành Trình Học Tập">
        ...
        <div class="narrative-grid-layout">
          <div class="narrative-spotlight-col">
            ${renderPrimarySpotlightCard(library, '📚 KHÔNG GIAN TRI THỨC')}
          </div>
          <div class="narrative-secondary-col">
      ...
      <!-- 6. TRUE NARRATIVE MODULE 4: ĐI CHƠI & THƯ GIÃN TỐI NAY (CF MANDATE #2) -->
      <section class="narrative-journey-module" id="journey-leisure" aria-label="Hành Trình Thư Giãn">
        ...
        <div class="narrative-grid-layout">
          <div class="narrative-spotlight-col">
            ${renderPrimarySpotlightCard(chamMuseum, '🏛️ DI SẢN VĂN HÓA')}
          </div>
          <div class="narrative-secondary-col">
      ...
      <div class="journey-results-section">
        ${filtered.length > 0 ? `
          <div class="journey-spotlight-wrapper">
            ${renderPrimarySpotlightCard(spotlight, '⭐ ĐỀ XUẤT HÀNG ĐẦU CHO BẠN')}
          </div>
  ...
  return `
    <div class="leisure-journey-page" id="leisure-journey-root">
      ...
      <div class="journey-results-section">
        ${filtered.length > 0 ? `
          <div class="journey-spotlight-wrapper">
            ${renderPrimarySpotlightCard(spotlight, '⭐ LỰA CHỌN NỔI BẬT TỐI NAY')}
          </div>
        ...
        <div class="header-inner">
          <div class="brand-lockup" role="button" tabindex="0" data-nav="HOME" aria-label="Về trang chủ JayT">
            ...
            <div class="brand-text-group">
              ...
              <span class="brand-tagline">Local Editorial &bull; v3.427.0-staging.cf</span>
            </div>
          </div>
      ...
      <footer class="jayt-footer-unified" role="contentinfo">
        <div class="footer-inner">
          <div class="footer-brand-col">
            ...
            <span class="footer-version">Phiên bản: v3.427.0-staging.cf &bull; Staging Review CF</span>
          </div>
        </div>
      </footer>
