...
(function(root) {
  ...
  const APPROVED_PUBLIC_ENTRIES = [
    ...
    {
      card_id: "B11_01_TRA_CUU_CHUYEN_BAY_DANANG_SMART_CITY_1022", public_eligible: true,
      evidence_contract_v3_status: "EVIDENCE_COMPLETE_INTERNAL_HELD__PUBLIC_APPROVED",
      ...
      safe_canonical_action: { url: "https://1022.vn/ra-mat-tien-ich-thong-tin-chuyen-bay-tren-ung-dung-danang-smart-city/", label: "Mở thông tin chuyến bay 1022 chính thức ↗", rel: "noopener noreferrer nofollow" },
      ceo_approval_id: "CEO-JAYT-323-B11-01-STAGING-ONLY"
    },
    {
      card_id: "B11_02_HOAT_DONG_VAN_HOA_BAO_TANG_CHAM_1022", public_eligible: true,
      evidence_contract_v3_status: "EVIDENCE_COMPLETE_INTERNAL_HELD__PUBLIC_APPROVED",
      exact_approved_copy: "Theo thông báo được công bố, chương trình vũ điệu Champa tổ chức vào buổi sáng ngày 15 và 30 hằng tháng.",
      exact_approved_title: "Lịch biểu diễn vũ điệu Champa — Bảo tàng Chăm Đà Nẵng",
      scope_caveat: "Thông tin lịch biểu diễn nghệ thuật văn hóa cộng đồng trích xuất từ thông báo chính thức của Bảo tàng Điêu khắc Chăm trên Cổng 1022 Đà Nẵng; không bán vé biểu diễn, không kinh doanh tour du lịch, không thu phí dịch vụ hay thu thập dữ liệu cá nhân.",
      safe_canonical_action: { url: "https://1022.vn/nhieu-trai-nghiem-moi-cho-du-khach-tai-bao-tang-dieu-khac-cham-da-nang/", label: "Mở thông báo lịch diễn 1022 chính thức ↗", rel: "noopener noreferrer nofollow" },
      ceo_approval_id: "JAYT_323_B11_02_PUBLIC_APPROVAL_STAGING_ONLY"
    },
  ];
  ...
  const RUNTIME_FINGERPRINT = {
    ledger_version: 'v3.483.0-staging.ao',
