...
(function(root) {
  ...
  const RUNTIME_FINGERPRINT = {
    ledger_version: 'v3.475.0-staging.eu',
    ledger_sha256: 'a4f6253f287b1145702deb6e42af8b72ac8d488863d02a3044e5b9af518ce8d4',
    counts: {
      an_gi: 11,
      di_dau: 14,
      tien_ich: 13,
...
// 3. SINGLE SOURCE OF COUNT INVARIANT
  ...
  // SECTION EU: SITUATIONAL ROUTE & CAMPUS ZONE STATE
  ...
  // 2. DAILY DISCOVERY HOME VIEW (SECTION EU: DEAL DISCOVERY ENGINE & 4 SITUATIONAL ROUTES)
  function renderDailyGuideHome() {
    ...
    return `
      <div class="cr-experience-container">
        ...
        <!-- SECTION EU: DEAL DISCOVERY ENGINE SURFACE -->
  ...
  // 7. BUY DECISION HUB & LOCAL-FIRST CALCULATOR (SECTION EU)
  ...
  // 7.5. TRUE THREE-LANE VOUCHER WALLET (SECTION EU)
  
  // 7.5. TRUE THREE-LANE VOUCHER WALLET & CLAIM-FREE INSTRUCTIONS (SECTION EU)
  
  // 7.5. TRUE THREE-LANE VOUCHER WALLET & NEUTRAL PORTAL IDENTITY (SECTION EU)
          ...
          ${(activeVoucherLane === 'ALL' || activeVoucherLane === 'LANE_B') ? `
            <section class="wallet-lane-section" style="margin-bottom: 32px; border: 1px solid var(--border-color); border-radius: 12px; padding: 20px; background: var(--bg-card-subtle);" aria-label="Làn B: Kênh chính thức để tự kiểm tra trong app">
              ...
              <p style="font-size: 0.88rem; color: var(--text-secondary); margin-bottom: 16px; line-height: 1.5;">
                💡 <strong>Nguyên tắc minh bạch tuyệt đối (Section EU):</strong> Các ưu đãi, nếu có, phụ thuộc hoàn toàn vào tài khoản cá nhân và giỏ hàng của bạn. <strong>JayT không hiển thị mã giả, không suy đoán chương trình hay số tiền giảm.</strong> Người dùng vui lòng mở ứng dụng hoặc website chính thức để tự kiểm tra trước khi thanh toán.
              </p>
      ...
      <div class="jayt-drawer-backdrop" id="drawer-backdrop">
        <div class="jayt-drawer-box" role="dialog" aria-modal="true" aria-labelledby="drawer-item-title" aria-describedby="drawer-item-desc">
          ...
          <div class="drawer-body" id="drawer-item-desc">
            ...
            <div class="drawer-section-card">
              <div class="drawer-section-title">🔍 Bằng Chứng Nguồn Tin & Đối Soát Thực Tế (Section EU)</div>
    ...
    root.innerHTML = `
      <div class="jayt-app-shell theme-${currentTheme}">
          ...
          <div class="header-inner">
            <div class="brand-lockup" role="button" tabindex="0" data-nav="HOME" aria-label="Về trang chủ JayT Đà Nẵng">
              ...
              <div class="brand-text-group">
                ...
                <span class="brand-tagline">Khám Phá Mỗi Ngày &bull; v3.475.0-staging.eu</span>
              </div>
            </div>
        ...
        <footer style="text-align: center; padding: 32px 16px; font-size: 0.8rem; color: var(--text-muted); border-top: 1px solid var(--border-color);" role="contentinfo">
          <div>JayT Đà Nẵng &bull; Chuẩn Tuyển Chọn Bản Địa DQ &bull; v3.475.0-staging.eu</div>
        </footer>
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
      JAYT_STOREFRONT_VERSION: 'v3.475.0-staging.eu',
