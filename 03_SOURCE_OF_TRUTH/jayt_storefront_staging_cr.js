/**
 * JAYT COMMUNITY OS — LOCAL EDITORIAL COMMERCE STOREFRONT (SECTION CR)
 * Release Candidate: v3.428.0-staging.cr
 * Governing Directive: JAYT-245 Section CR (Lines 2289-2304) - Unified Art Direction & Mobile Restraint
 * Architecture Upgrades:
 *  - Mobile Editorial Restraint: Compact 52px header, single dominant Coral CTA, City Note separated from Hero
 *  - Unified Art Direction: Photography-led coastal lighting and matching diffuse ambient styling
...
if (typeof window !== 'undefined' && window.JAYT_OBSERVABILITY) {
  window.JAYT_OBSERVABILITY.recordEvent('STOREFRONT_INITIALIZED', {
    version: 'v3.428.0-staging.cr',
    environment: 'STAGING_REVIEW_CR',
    theme: 'COASTAL_SIGNATURE_RESTRICTION',
    dom_isolation: 'STRICT_ZERO_DOM_INJECTION'
  });
}

const JAYT_STOREFRONT_VERSION = 'v3.428.0-staging.cr';
...
// 1. SIGNATURE HOME VIEW (SECTION CR)
function renderDailyGuideHome() {
  const timeInfo = getCurrentTimeSlotInfo();

  return `
    <div class="cr-experience-container">
      <!-- 1. LANDMARK-LED HERO WITH RESTRAINED ACTIONS -->
      <section class="hero-landmark-cr vivid-dragon-hero-cf" aria-label="Bìa Cẩm Nang Sống Đà Nẵng">
        <img 
        ...
        <div class="hero-landmark-content">
          ...
          <div class="hero-actions-cr">
            <button class="btn-hero-primary-cr btn-primary-action-cf" data-nav="FOOD_JOURNEY">
              🍜 Khám phá ẩm thực hôm nay &rarr;
            </button>
          </div>
        </div>
      </section>

      <!-- 2. COMPACT CIVIC TICKER (CLEAN SEPARATION) -->
      ...
      <!-- 3. STORY BLOCK 1: CULINARY (HUỲNH THÚC KHÁNG) -->
      <section class="story-block-cr" id="journey-food" aria-label="Hành Trình Ẩm Thực">
        <div class="story-media-stage spotlight-visual-stage-cn">
          <img 
            src="assets/images/danang_food_mi_quang_photo.svg" 
            alt="Mì Quảng Huỳnh Thúc Kháng" 
            class="story-media-img spotlight-visual-img-cn" 
            loading="eager"
          />
          <div class="story-attribution-tag spotlight-visual-attribution-tag">
            🍜 Phố Huỳnh Thúc Kháng &bull; JayT Editorial
          </div>
        </div>

        <div class="story-content-box">
          <span class="story-kicker">🍜 ĐỀ XUẤT ẨM THỰC BẢN ĐỊA</span>
          <h2 class="story-heading">Mì Quảng Phố Huỳnh Thúc Kháng</h2>
          ...
          <div class="story-actions-row">
            <a href="https://www.google.com/maps/search/?api=1&query=Ph%E1%BB%91%20Hu%E1%BB%B3nh%20Th%C3%BAc%20Kh%C3%A1ng%20%C4%90%C3%A0%20N%E1%BA%B5ng" target="_blank" rel="noopener noreferrer" class="btn-story-action">
              📍 Chỉ đường Google Maps &rarr;
            </a>
            <button class="btn-story-secondary" data-nav="FOOD_JOURNEY">
      ...
      <!-- 4. STORY BLOCK 2: GREEN TRANSIT (DANABUS) -->
      <section class="story-block-cr" id="journey-transport" aria-label="Giao Thông Công Cộng">
        <div class="story-media-stage spotlight-visual-stage-cn">
          <img 
        ...
        <div class="story-content-box">
          <span class="story-kicker">🚌 GIAO THÔNG CÔNG CỘNG XANH</span>
          <h2 class="story-heading">Mạng Lưới Xe Buýt Trợ Giá DanaBus</h2>
          <p class="story-narrative">
            Hệ thống xe buýt kết nối Sân bay, Bến xe trung tâm và các trường đại học với giá vé trợ giá công dân và học sinh sinh viên.
          </p>
          <div class="story-actions-row">
            <a href="https://danangbus.vn" target="_blank" rel="noopener noreferrer" class="btn-story-action">
      ...
      <!-- 5. STORY BLOCK 3: KNOWLEDGE & STUDY (LIBRARY) -->
      <section class="story-block-cr" id="journey-study" aria-label="Không Gian Tự Học">
        <div class="story-media-stage spotlight-visual-stage-cn">
          <img 
        ...
        <div class="story-content-box">
          <span class="story-kicker">🎓 KHÔNG GIAN TRI THỨC CÔNG CỘNG</span>
          <h2 class="story-heading">Thư Viện KHTH Đà Nẵng Ven Sông Hàn</h2>
          <p class="story-narrative">
          ...
          <div class="story-actions-row">
            <a href="https://danang.gov.vn" target="_blank" rel="noopener noreferrer" class="btn-story-action">
      ...
      <!-- 6. STORY BLOCK 4: EVENING HERITAGE & LEISURE (CHAM MUSEUM) -->
      <section class="story-block-cr" id="journey-leisure" aria-label="Văn Hóa & Điểm Hẹn Tối">
        <div class="story-media-stage spotlight-visual-stage-cn">
          <img 
        ...
        <div class="story-content-box">
          <span class="story-kicker">✨ DI SẢN & ĐIỂM ĐẾN VĂN HÓA</span>
          <h2 class="story-heading">Bảo Tàng Điêu Khắc Chăm & Đêm Sông Hàn</h2>
          <p class="story-narrative">
          ...
          <div class="story-actions-row">
            <a href="http://chammuseum.vn" target="_blank" rel="noopener noreferrer" class="btn-story-action">
              🏛️ Xem thông tin tham quan &rarr;
            </a>
            <button class="btn-story-secondary" data-nav="LEISURE_JOURNEY">
...
function renderExploreDirectory() {
  ...
  return `
    <div class="cr-experience-container">
      <div class="civic-ticker-cr">
        <span class="story-kicker">📚 THƯ MỤC NGUỒN CUNG TP. ĐÀ NẴNG</span>
      </div>

      <div style="background: var(--bg-card); padding: 20px; border-radius: var(--radius-md); border: 1px solid var(--border-color);">
        <h1 style="font-size: 1.6rem; font-weight: 800; margin-bottom: 8px;">Khám Phá Toàn Diện (50 Mục Đã Phân Tầng)</h1>
        <p style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 16px;">
          Tra cứu đầy đủ ẩm thực, tiện ích, giải trí, xe buýt và đặc quyền học đường tại Đà Nẵng.
        </p>

        <div style="display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 12px;">
          <button class="nav-btn ${activeGateway === 'ALL' ? 'active' : ''}" data-exp-gw="ALL">Tất cả</button>
  ...
  root.innerHTML = `
    <div class="jayt-app-shell theme-${currentTheme}">
        ...
        <div class="header-inner">
          <div class="brand-lockup" role="button" tabindex="0" data-nav="HOME" aria-label="Về trang chủ JayT">
            <svg width="28" height="28" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <path d="M19 6 V19 C19 24.5 15.5 28 10 28 C6.5 28 4.2 26 3.5 24 C5.2 24 7 22.8 7.5 20.8 C8 18.5 6.5 16.5 4.5 16.5 C3.8 16.5 3 16.8 2.5 17.2 C3.5 10.5 11 6 19 6 Z" fill="url(#jflow-logo-grad-cr)"/>
              <path d="M19 14 C23.5 14 27.5 17 29.5 21 C31 24 32.5 28 33.5 31 C29.5 29 25 27.5 19 27.5 V21.5 C22 21.5 24.5 23 26 24.5 C24.5 20 20.5 17.5 16 17 L19 14 Z" fill="url(#jflow-logo-grad-cr)" opacity="0.9"/>
              <circle cx="27" cy="8" r="3.5" fill="#f43f5e"/>
              <defs>
                <linearGradient id="jflow-logo-grad-cr" x1="4" y1="4" x2="34" y2="34" gradientUnits="userSpaceOnUse">
            ...
            <div class="brand-text-group">
              ...
              <span class="brand-tagline">Đà Nẵng Mở Cửa &bull; v3.428.0-staging.cr</span>
            </div>
          </div>
      ...
      <footer style="text-align: center; padding: 32px 16px; font-size: 0.8rem; color: var(--text-muted); border-top: 1px solid var(--border-color);" role="contentinfo">
        <div>JayT Đà Nẵng &bull; Chuẩn Signature Board B &bull; v3.428.0-staging.cr</div>
      </footer>
