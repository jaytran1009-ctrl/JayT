...
const JAYT_STOREFRONT_VERSION = 'v3.423.1-staging.bl';
...
function renderSpotlightLargeCard(item) {
  ...
  return `
    <article class="editorial-card card-spotlight-feature card-spotlight-editorial-bl" data-item-id="${itemId}" data-category="${item.category}">
      <div class="spotlight-editorial-banner">
        <div class="spotlight-kicker-tag">ĐIỂM CHỌN HÔM NAY • ĐÃ ĐỐI SOÁT CHỨNG CỨ</div>
        <h3 class="spotlight-headline">${item.title}</h3>
        <p class="spotlight-subtext">Chương trình Mua 1 vé tặng 1 vé xem phim 2D khi thanh toán qua VNPAY-QR tại các cụm rạp CGV TP. Đà Nẵng.</p>
        <div class="spotlight-badges-row">
          <span class="spot-badge">📅 Thứ 6, Thứ 7, Chủ Nhật</span>
          <span class="spot-badge">📍 Cụm rạp CGV Đà Nẵng</span>
          <span class="spot-badge spot-badge-success">✓ Đã kiểm tra thể lệ</span>
        </div>
      </div>

      <div class="card-inner-body">
        <p class="card-summary">${item.summary_text || item.summary || ""}</p>
        <div class="card-action-bar">
          <button class="btn-card-detail btn-spotlight-main" data-card-detail="${itemId}">
            Xem lịch chiếu & điều kiện đối soát &rarr;
          </button>
          <a href="${item.official_source_url}" target="_blank" rel="noopener noreferrer" class="btn-card-source">
            Mở CGV chính thức &nearr;
          </a>
        </div>
      </div>
    </article>
...
function renderDailyGuideHome() {
  ...
  return `
    <div class="home-guide-layout-bl">
      <!-- 1. HERO CUSTOMER DECISION FLOW: TỐI NAY / GẦN TÔI / NGÂN SÁCH CỦA TÔI -->
      <section class="hero-decision-section-bl" aria-label="Khám phá theo quyết định thực tế">
        <div class="hero-decision-header">
          <div class="hero-kicker-badge">
            <span class="pulse-dot"></span> JAYT ĐÀ NẴNG &bull; CẨM NANG ĐỘC LẬP
          </div>
          <h1 class="hero-editorial-headline">
            Tối Nay Ở Đà Nẵng:<br>
            <span class="headline-gradient-text">Đi Đâu, Ăn Gì, Chi Tiêu Thế Nào?</span>
          </h1>
          <p class="hero-editorial-subtext">
            Cẩm nang tuyển chọn độc lập — 100% ưu đãi có đối soát bằng chứng, địa điểm đô thị và quyền lợi học đường chính thức tại TP. Đà Nẵng.
          </p>

          <!-- Interactive 3-Way Filter Bar -->
          <div class="decision-filters-box-bl">
            <div class="filter-col">
              <label for="filter-locality" class="filter-label">📍 Khu vực:</label>
              <select id="filter-locality" class="filter-select-bl">
            ...
            <div class="filter-col">
              <label for="filter-time" class="filter-label">⏰ Thời điểm:</label>
              <select id="filter-time" class="filter-select-bl">
            ...
            <div class="filter-col">
              <label for="filter-budget" class="filter-label">💰 Ngân sách:</label>
              <select id="filter-budget" class="filter-select-bl">
            ...
            <button id="btn-apply-decision" class="btn-decision-submit">Tìm lựa chọn phù hợp &rarr;</button>
          </div>
        </div>
      </section>

      <!-- 2. DAILY PICK (ĐIỂM CHỌN HÔM NAY - 1 ITEM NỔI BẬT NHẤT) -->
      <section class="section-daily-pick-bl" aria-label="Điểm chọn nổi bật hôm nay">
        <div class="section-header-editorial">
          <span class="section-kicker kicker-deal">🔥 LỰA CHỌN NỔI BẬT HÔM NAY</span>
          <h2 class="section-title-editorial">Ưu Đãi Đã Đối Soát Hợp Lệ</h2>
        </div>
      ...
      <!-- 3. 3 CỬA VÀO QUYẾT ĐỊNH (3 DECISION ENTRY TILES) -->
      <section class="section-journey-tiles" aria-label="3 Cửa Vào Khám Phá">
        <div class="section-header-editorial">
          <span class="section-kicker">3 CỬA VÀO KHÁM PHÁ</span>
          <h2 class="section-title-editorial">Bạn Đang Cần Gì?</h2>
        </div>

        <div class="journey-tiles-grid">
          <!-- Entry 1: Ăn Gì Tối Nay -->
          <div class="decision-entry-card entry-food" role="button" tabindex="0" data-gateway-target="AN_GI">
            <div class="entry-card-top">
              <span class="entry-icon">🍔</span>
              <span class="entry-category-tag">ẨM THỰC & HẸN HÒ</span>
            </div>
            <h3 class="entry-headline">Ăn gì tối nay?</h3>
            <p class="entry-subtext">Gợi ý bữa tối, thực đơn bình dân, gà giòn, pizza và trà sữa học sinh sinh viên.</p>
            <span class="entry-action-link">Khám phá 7 địa điểm ăn uống &rarr;</span>
          </div>

          <!-- Entry 2: Kèo Nhóm Đi Đâu -->
          <div class="decision-entry-card entry-places" role="button" tabindex="0" data-gateway-target="DI_DAU">
            <div class="entry-card-top">
              <span class="entry-icon">🎬</span>
              <span class="entry-category-tag">GIẢI TRÍ & ĐI LẠI</span>
            </div>
            <h3 class="entry-headline">Kèo nhóm đi đâu?</h3>
            <p class="entry-subtext">Suất chiếu rạp CGV/Metiz, dạo sông Hàn, ngắm Cầu Rồng và tuyến xe buýt nhanh.</p>
            <span class="entry-action-link">Xem lịch rạp & đường đi &rarr;</span>
          </div>

          <!-- Entry 3: Học Tập & Mua Sắm -->
          <div class="decision-entry-card entry-tools" role="button" tabindex="0" data-gateway-target="MUA_GI">
            <div class="entry-card-top">
              <span class="entry-icon">🛍️</span>
              <span class="entry-category-tag">CÔNG CỤ & TIỆN ÍCH</span>
            </div>
            <h3 class="entry-headline">Học tập & Mua sắm</h3>
            <p class="entry-subtext">Bản quyền GitHub, Notion, Canva, Apple Music và dịch vụ công đô thị.</p>
            <span class="entry-action-link">Nhận gói sinh viên & tiện ích &rarr;</span>
          </div>
        </div>
      </section>

      <!-- 4. CIVIC FACILITIES & MOBILITY (ĐI GẦN BẠN) -->
      ...
      <!-- 5. BUY DECISION HUB (CẦN MUA MÓN NÀY?) -->
      ...
      <!-- 6. OFFICIAL PROGRAMMES RAIL (QUYỀN LỢI HỌC ĐƯỜNG) -->
      ...
      <!-- 7. RADAR THEO DÕI NGUỒN (DANH SÁCH THU GỌN) -->
