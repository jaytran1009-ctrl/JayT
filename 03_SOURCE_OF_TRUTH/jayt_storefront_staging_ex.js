...
(function(root) {
  ...
  const RUNTIME_FINGERPRINT = {
    ledger_version: 'v3.477.0-staging.ex',
    ledger_sha256: '42a28053552ed407fe3f65c40a1d703aae792798418d6a3fb179a8660c32e693',
    counts: {
      an_gi: 11,
      di_dau: 14,
      tien_ich: 13,
...
// 3. SINGLE SOURCE OF COUNT INVARIANT
  ...
  // SECTION EX: SITUATIONAL ROUTE & CAMPUS ZONE STATE
  ...
  // 2. DAILY DISCOVERY HOME VIEW (SECTION EX: DEAL DISCOVERY ENGINE & 4 SITUATIONAL ROUTES)
  function renderDailyGuideHome() {
    ...
    return `
      <div class="cr-experience-container">
        ...
        <!-- SECTION EX: DEAL DISCOVERY ENGINE SURFACE -->
  ...
  // 7. BUY DECISION HUB & LOCAL-FIRST CALCULATOR (SECTION EX)
  ...
  // 7.5. TRUE THREE-LANE VOUCHER WALLET (SECTION EX)
  
  // 7.5. TRUE THREE-LANE VOUCHER WALLET & CLAIM-FREE INSTRUCTIONS (SECTION EX)
  
  // 7.5. TRUE THREE-LANE VOUCHER WALLET & NEUTRAL PORTAL IDENTITY (SECTION EX)
          ...
          ${(activeVoucherLane === 'ALL' || activeVoucherLane === 'LANE_B') ? `
            <section class="wallet-lane-section" style="margin-bottom: 32px; border: 1px solid var(--border-color); border-radius: 12px; padding: 20px; background: var(--bg-card-subtle);" aria-label="Làn B: Kênh chính thức để tự kiểm tra trong app">
              ...
              <p style="font-size: 0.88rem; color: var(--text-secondary); margin-bottom: 16px; line-height: 1.5;">
                💡 <strong>Nguyên tắc minh bạch tuyệt đối (Section EX):</strong> Các ưu đãi, nếu có, phụ thuộc hoàn toàn vào tài khoản cá nhân và giỏ hàng của bạn. <strong>JayT không hiển thị mã giả, không suy đoán chương trình hay số tiền giảm.</strong> Người dùng vui lòng mở ứng dụng hoặc website chính thức để tự kiểm tra trước khi thanh toán.
              </p>
      ...
      <div class="jayt-drawer-backdrop" id="drawer-backdrop">
        <div class="jayt-drawer-box" role="dialog" aria-modal="true" aria-labelledby="drawer-item-title" aria-describedby="drawer-item-desc">
          ...
          <div class="drawer-body" id="drawer-item-desc">
            ...
            <div class="drawer-section-card">
              <div class="drawer-section-title">🔍 Bằng Chứng Nguồn Tin & Đối Soát Thực Tế (Section EX)</div>
    ...
    root.innerHTML = `
      <div class="jayt-app-shell theme-${currentTheme}">
          ...
          <div class="header-inner">
            <div class="brand-lockup" role="button" tabindex="0" data-nav="HOME" aria-label="Về trang chủ JayT Đà Nẵng">
              ...
              <div class="brand-text-group">
                ...
                <span class="brand-tagline">Khám Phá Mỗi Ngày &bull; v3.477.0-staging.ex</span>
              </div>
            </div>
        ...
        <footer style="text-align: center; padding: 32px 16px; font-size: 0.8rem; color: var(--text-muted); border-top: 1px solid var(--border-color);" role="contentinfo">
          <div>JayT Đà Nẵng &bull; Chuẩn Tuyển Chọn Bản Địa DQ &bull; v3.477.0-staging.ex</div>
        </footer>
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
      JAYT_STOREFRONT_VERSION: 'v3.477.0-staging.ex',
