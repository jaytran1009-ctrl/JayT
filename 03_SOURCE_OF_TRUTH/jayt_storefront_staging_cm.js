/**
 * JAYT COMMUNITY OS — LOCAL EDITORIAL COMMERCE STOREFRONT (SECTION CM)
 * Release Candidate: v3.427.6-staging.cm
 * Governing Directive: JAYT-245 Section CM (Lines 2183-2206) - Quyết Định CEO
 * Chosen Direction: Board B — "Đà Nẵng Mở Cửa" (Warm Sand, Ocean Blue, Soft Coral)
 *  - 100% Clean Single Storefront (Zero internal toolbars / zero board selectors)
 *  - Zero Empty Media Frames: High-Def Rights-Cleared Da Nang Visual Scenes
 *  - Arrival: Atmospheric "Đà Nẵng Mở Cửa" Coastal Hero with Light Scrim
 *  - Curated Local Editorial Feature Showcases (Food, Transit, Learning, Culture)
 *  - Honest Audited Ranking Rationale & Local Storytelling
 *  - Closed-Loop Action Contracts & Three-Lane Wallet
...
if (typeof window !== 'undefined' && window.JAYT_OBSERVABILITY) {
  window.JAYT_OBSERVABILITY.recordEvent('STOREFRONT_INITIALIZED', {
    version: 'v3.427.6-staging.cm',
    environment: 'STAGING_REVIEW_CM',
    theme: 'DA_NANG_MO_CUA_BOARD_B',
    dom_isolation: 'STRICT_ZERO_DOM_INJECTION'
  });
}

const JAYT_STOREFRONT_VERSION = 'v3.427.6-staging.cm';
...
const JAYT_DISCOVERY_ITEMS = [
  ...
  },
  {
    ...
    "visual_asset_url": "assets/images/danang_danabus_real_002.svg",
  ...
  },
  {
    ...
    "visual_asset_url": "assets/images/danang_library_real_004.svg",
  ...
  },
  {
    ...
    "visual_asset_url": "assets/images/danang_cham_museum_real_003.svg",
  ...
  },
  {
    ...
    "visual_asset_url": "assets/images/danang_mi_quang_real_001.svg",
...
// Render Magazine-Style Primary Showcase Card (Zero Empty Boxes)
function renderPrimarySpotlightCard(item, kickerText) {
  ...
  return `
    <article class="primary-archetype-card archetype-${item.visual_archetype.toLowerCase()} magazine-spotlight-cl" data-item-id="${item.item_id}">
      <!-- VERIFIED HIGH-DEF VISUAL STAGE -->
      ${item.visual_asset_url ? `
        <div class="spotlight-visual-stage-cl">
          <img 
            src="${item.visual_asset_url}" 
            alt="${item.title}" 
            class="spotlight-visual-img-cl" 
            loading="lazy"
          />
...
// 1. HOME VIEW (THEMED BY "ĐÀ NẴNG MỞ CỬA" - WARM SAND & OCEAN COASTAL)
function renderDailyGuideHome() {
  ...
  return `
    <div class="home-editorial-layout-cl theme-coastal-open-cm">
      <!-- 1. ARRIVAL: "ĐÀ NẴNG MỞ CỬA" COASTAL HERO (WARM SAND & OCEAN BLUE) -->
      <section class="vivid-dragon-hero-cf hero-coastal-cm" aria-label="Bìa Cẩm Nang Sống Đà Nẵng">
        <div class="vivid-hero-stage">
          <img 
            src="assets/images/danang_coastal_real_hero.svg" 
            alt="Toàn cảnh Đà Nẵng Mở Cửa — Bờ biển Mỹ Khê, Bán đảo Sơn Trà và Cầu Rồng ban mai rạng rỡ" 
            class="vivid-hero-image" 
            id="hero-main-photo"
            loading="eager"
          />
          <div class="vivid-hero-scrim-coastal"></div>
          
          <div class="vivid-credit-tag" tabindex="0" role="note" aria-label="Thông tin bản quyền ảnh">
            🏖️ Đà Nẵng Mở Cửa &bull; 📷 JayT Editorial Studio (CC BY-SA 4.0)
          </div>
        </div>
        ...
        <div class="vivid-hero-overlay">
          <div class="vivid-header-group">
            ...
            <h1 class="vivid-main-title">
              Đà Nẵng Mở Cửa & Khám Phá Nhịp Sống Đô Thị
            </h1>
            <p class="vivid-subhead">
              Cẩm nang địa phương kết nối ẩm thực xứ Quảng, giao thông xanh công cộng và tiện ích học đường chính thống.
            </p>

            <!-- 3 CONCISE ACTION BUTTONS -->
            <div class="vivid-actions-bar">
              <button class="btn-primary-action-cf btn-coral-action-cm" data-nav="FOOD_JOURNEY">
                🍜 Ăn gì gần đây?
              </button>
              <div class="chips-horizontal-group">
                <button class="chip-secondary-cf" data-explore-gw="DI_DAU">
                  🚌 Di chuyển công cộng
                </button>
      ...
      <!-- 2. NARRATIVE COLLECTION 1: ẨM THỰC XỨ QUẢNG & ĐIỂM TÂM PHỐ BIỂN -->
      <section class="narrative-journey-module" id="journey-food" aria-label="Hành Trình Ẩm Thực">
        <div class="narrative-module-header">
          <div>
            <span class="journey-kicker-tag">🍜 HÀNH TRÌNH 1 &bull; ẨM THỰC XỨ QUẢNG</span>
            <h2 class="journey-title-ca">Hương Vị Bản Địa & Điểm Hẹn Ăn Uống</h2>
          </div>
      ...
      <!-- 3. NARRATIVE COLLECTION 2: DI CHUYỂN & GIAO THÔNG XANH (DANABUS ARTWORK) -->
      <section class="narrative-journey-module" id="journey-transport" aria-label="Hành Trình Di Chuyển">
        <div class="narrative-module-header">
          <div>
            <span class="journey-kicker-tag">🚌 HÀNH TRÌNH 2 &bull; DI CHUYỂN XANH</span>
      ...
      <!-- 4. NARRATIVE COLLECTION 3: HỌC TẬP & LÀM VIỆC (LIBRARY ARTWORK) -->
      <section class="narrative-journey-module" id="journey-study" aria-label="Hành Trình Học Tập">
        <div class="narrative-module-header">
          <div>
            <span class="journey-kicker-tag">🎓 HÀNH TRÌNH 3 &bull; HỌC TẬP & TRI THỨC</span>
      ...
      <!-- 5. NARRATIVE COLLECTION 4: VĂN HÓA & GIẢI TRÍ TỐI NAY (AFTER-HOURS MOMENT) -->
      <section class="narrative-journey-module" id="journey-leisure" aria-label="Hành Trình Thư Giãn">
        <div class="narrative-module-header">
          <div>
            <span class="journey-kicker-tag">✨ HÀNH TRÌNH 4 &bull; VĂN HÓA & GIẢI TRÍ TỐI NAY</span>
...
function renderAppShell() {
  ...
  root.innerHTML = `
    <div class="jayt-app-shell theme-${currentTheme} theme-coastal-shell">
        ...
        <div class="header-inner">
          <div class="brand-lockup" role="button" tabindex="0" data-nav="HOME" aria-label="Về trang chủ JayT">
            ...
            <div class="brand-text-group">
              ...
              <span class="brand-tagline">Đà Nẵng Mở Cửa &bull; v3.427.6-staging.cm</span>
            </div>
          </div>
      ...
      <footer class="jayt-footer-unified" role="contentinfo">
        <div class="footer-inner">
          <div class="footer-brand-col">
            <span class="footer-title">JayT Đà Nẵng &bull; Đà Nẵng Mở Cửa</span>
            <p class="footer-mission">
              Nền tảng cẩm nang cộng đồng Đà Nẵng. Phong cách thiết kế Coastal Editorial tươi sáng, ấm áp, kết nối văn hóa và đời sống người dân thành phố.
            </p>
            <span class="footer-version">Phiên bản: v3.427.6-staging.cm &bull; Section CM Release</span>
          </div>
        </div>
      </footer>
