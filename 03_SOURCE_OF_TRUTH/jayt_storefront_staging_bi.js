...
const JAYT_STOREFRONT_VERSION = 'v3.422.8-staging.bi';
...
function renderDailyGuideHome() {
  ...
  return `
    <div class="home-guide-layout">
      ...
      <!-- Section 1: Spotlight Deal Xác Minh Chính Chủ (1 Item) -->
      <section class="content-rail-section spotlight-rail-section">
        <div class="rail-header">
          <div>
            <span class="rail-kicker kicker-deal">SPOTLIGHT • CHIẾN DỊCH XÁC MINH CHÍNH CHỦ</span>
            <h2 class="rail-title">Ưu Đãi Nổi Bật Hôm Nay</h2>
          </div>
          <span class="rail-meta">1 deal có chứng cứ</span>
        </div>
        <div class="spotlight-feature-container">
