...
const JAYT_STOREFRONT_VERSION = 'v3.422.4-staging.be';
  ...
  return `
    <div class="home-guide-layout">
      ...
      <section class="guide-hero-section">
        ...
        <p class="hero-description">Cẩm nang tiện ích và quyền lợi cộng đồng Đà Nẵng — Phân tầng minh bạch theo cấp độ xác minh.</p>
      ...
      <!-- The 3 Primary Daily Gateways (Strict Need-Based, Zero Unbound Claims) -->
