...
const JAYT_STOREFRONT_VERSION = 'v3.422.9-staging.bj';
...
const BRAND_VISUAL_ASSETS = {
  DEAL_CGV_VNPAY_BOGO: {
    badge: "CHIẾN DỊCH XÁC MINH CHÍNH CHỦ",
    merchant_name: "CGV Cinemas x VNPAY",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 40 24" fill="none"><rect width="40" height="24" rx="4" fill="#dc2626"/><text x="20" y="16" fill="white" font-family="'Plus Jakarta Sans', sans-serif" font-weight="900" font-size="11" text-anchor="middle">CGV</text></svg>`,
    poster_banner: `
      <div class="campaign-poster-banner cgv-vnpay-poster">
        <div class="poster-overlay-badge">BOGO • MUA 1 VÉ TẶNG 1 VÉ</div>
        <div class="poster-visual-content">
          <span class="poster-brand-callout">CGV Cinemas &bull; VNPAY QR</span>
          <h4 class="poster-headline">Tặng 01 Vé Xem Phim 2D Cuối Tuần</h4>
          <span class="poster-subtext">Áp dụng suất chiếu Thứ 6, Thứ 7, Chủ Nhật tại Đà Nẵng</span>
        </div>
      </div>
    `
  },
  PENDING_DEAL_LOTTERIA_LUNCH: {
    merchant_name: "Lotteria Vietnam",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 32 32" fill="none"><circle cx="16" cy="16" r="16" fill="#ef4444"/><text x="16" y="21" fill="white" font-family="'Plus Jakarta Sans', sans-serif" font-weight="900" font-size="14" text-anchor="middle">L</text></svg>`
  },
  PENDING_DEAL_DOMINOS_BOGO: {
    merchant_name: "Domino's Pizza",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 32 32" fill="none"><rect width="32" height="32" rx="6" fill="#0284c7"/><text x="16" y="21" fill="white" font-family="'Plus Jakarta Sans', sans-serif" font-weight="900" font-size="14" text-anchor="middle">D</text></svg>`
  },
  PENDING_DEAL_METIZ_U22: {
    merchant_name: "Metiz Cinema Đà Nẵng",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 32 32" fill="none"><rect width="32" height="32" rx="6" fill="#0f766e"/><text x="16" y="21" fill="white" font-family="'Plus Jakarta Sans', sans-serif" font-weight="900" font-size="13" text-anchor="middle">M</text></svg>`
  },
  PENDING_DEAL_STARLIGHT_COMBO: {
    merchant_name: "Starlight Cinema Đà Nẵng",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 32 32" fill="none"><rect width="32" height="32" rx="6" fill="#7c3aed"/><text x="16" y="21" fill="white" font-family="'Plus Jakarta Sans', sans-serif" font-weight="900" font-size="13" text-anchor="middle">S</text></svg>`
  },
  OFFICIAL_GITHUB_STUDENT_PACK: {
    merchant_name: "GitHub Education",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 32 32" fill="none"><circle cx="16" cy="16" r="16" fill="#181717"/><path d="M16 8 C11.58 8 8 11.58 8 16 C8 19.53 10.3 22.5 13.5 23.57 C13.9 23.64 14.05 23.4 14.05 23.18 V21.7 C11.8 22.18 11.33 20.62 11.33 20.62 C10.96 19.68 10.43 19.43 10.43 19.43 C9.7 18.93 10.5 18.94 10.5 18.94 C11.3 19 11.72 19.78 11.72 19.78 C12.44 21 13.62 20.65 14.08 20.44 C14.15 19.92 14.36 19.56 14.6 19.36 C12.8 19.16 10.9 18.46 10.9 15.36 C10.9 14.48 11.22 13.75 11.74 13.18 C11.66 12.98 11.38 12.16 11.82 11.06 C11.82 11.06 12.5 10.84 14.05 11.88 C14.7 11.7 15.38 11.6 16.05 11.6 C16.72 11.6 17.4 11.7 18.05 11.88 C19.6 10.84 20.28 11.06 20.28 11.06 C20.72 12.16 20.44 12.98 20.36 13.18 C20.88 13.75 21.2 14.48 21.2 15.36 C21.2 18.47 19.3 19.15 17.5 19.35 C17.8 19.6 18.08 20.12 18.08 20.92 V23.18 C18.08 23.4 18.22 23.65 18.63 23.57 C21.83 22.5 24.1 19.53 24.1 16 C24.1 11.58 20.52 8 16 8 Z" fill="white"/></svg>`
  },
  OFFICIAL_NOTION_STUDENT: {
    merchant_name: "Notion Labs",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 32 32" fill="none"><rect width="32" height="32" rx="6" fill="#000000"/><text x="16" y="22" fill="white" font-family="'Plus Jakarta Sans', sans-serif" font-weight="900" font-size="15" text-anchor="middle">N</text></svg>`
  },
  OFFICIAL_CANVA_STUDENT: {
    merchant_name: "Canva",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 32 32" fill="none"><circle cx="16" cy="16" r="16" fill="#00c4cc"/><text x="16" y="21" fill="white" font-family="'Plus Jakarta Sans', sans-serif" font-weight="900" font-size="14" text-anchor="middle">C</text></svg>`
  },
  OFFICIAL_SPOTIFY_STUDENT: {
    merchant_name: "Spotify",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 32 32" fill="none"><circle cx="16" cy="16" r="16" fill="#1db954"/><circle cx="16" cy="16" r="8" stroke="white" stroke-width="2" fill="none"/></svg>`
  },
  OFFICIAL_APPLE_MUSIC_STUDENT: {
    merchant_name: "Apple Music",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 32 32" fill="none"><circle cx="16" cy="16" r="16" fill="#fa243c"/><path d="M12 18 C12 20 14 20 15 19 V13 L20 12 V17 C20 19 22 19 23 18 V10 L12 12 V18 Z" fill="white"/></svg>`
  },
  FACILITY_DANABUS: {
    merchant_name: "DanaBus Đà Nẵng",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 32 32" fill="none"><rect width="32" height="32" rx="6" fill="#0284c7"/><text x="16" y="21" fill="white" font-family="'Plus Jakarta Sans', sans-serif" font-weight="900" font-size="11" text-anchor="middle">BUS</text></svg>`
  },
  FACILITY_TNGO_BIKE: {
    merchant_name: "TNGO Bike Đà Nẵng",
    logo_svg: `<svg class="merchant-logo-svg" viewBox="0 0 32 32" fill="none"><rect width="32" height="32" rx="6" fill="#059669"/><text x="16" y="21" fill="white" font-family="'Plus Jakarta Sans', sans-serif" font-weight="900" font-size="11" text-anchor="middle">TNGO</text></svg>`
  }
};
...
function renderSpotlightLargeCard(item) {
  ...
  const brandAsset = BRAND_VISUAL_ASSETS[itemId] || {};

  return `
    <article class="editorial-card card-spotlight-feature" data-item-id="${itemId}" data-category="${item.category}">
      ${brandAsset.poster_banner || ''}
      <div class="card-inner-body">
        <div class="card-header-row">
          <div class="merchant-brand-lockup">
            ${brandAsset.logo_svg || `<div class="brand-monogram">${item.title.charAt(0)}</div>`}
            <div class="brand-titles">
              <span class="merchant-label">${brandAsset.merchant_name || item.title}</span>
        ...
        <div class="card-meta-chips">
          ...
          <span class="meta-chip chip-verified">Suất chiếu cuối tuần</span>
...
function renderDailyGuideHome() {
  ...
  return `
    <div class="home-guide-layout-bj">
      <!-- 1. HERO FULL-BLEED: ĐÀ NẴNG AFTER CLASS -->
      <section class="hero-after-class-fullbleed" aria-label="Hero Đà Nẵng After Class">
        <div class="hero-visual-backdrop-bj">
          <svg class="hero-city-scene-svg" viewBox="0 0 1440 480" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
            <defs>
              <linearGradient id="danang-dusk-grad-bj" x1="0" y1="0" x2="1440" y2="480" gradientUnits="userSpaceOnUse">
                <stop stop-color="#0b1329" />
                <stop offset="0.4" stop-color="#1e1b4b" />
                <stop offset="0.8" stop-color="#311042" />
                <stop offset="1" stop-color="#c2410c" />
              </linearGradient>
              <radialGradient id="sun-glow-bj" cx="1200" cy="180" r="300" gradientUnits="userSpaceOnUse">
                <stop stop-color="#f97316" stop-opacity="0.6"/>
                <stop offset="1" stop-color="#f97316" stop-opacity="0"/>
              </radialGradient>
            </defs>
            <rect width="1440" height="480" fill="url(#danang-dusk-grad-bj)"/>
            <circle cx="1200" cy="180" r="300" fill="url(#sun-glow-bj)"/>
            <!-- Bridge Curves -->
            <path d="M0 400 Q 360 280 720 380 T 1440 320" stroke="#f97316" stroke-width="4" opacity="0.6"/>
            <path d="M0 430 Q 400 310 800 410 T 1440 350" stroke="#38bdf8" stroke-width="2" opacity="0.4"/>
            <!-- River Waves -->
            <path d="M0 450 C 300 420, 600 480, 900 440 C 1200 400, 1350 460, 1440 450 L 1440 480 L 0 480 Z" fill="#030712" opacity="0.7"/>
          </svg>
        </div>

        <div class="hero-after-class-content">
          <div class="hero-kicker-badge">
            <span class="pulse-dot"></span> JAYT DAILY EDIT &bull; ĐÀ NẴNG AFTER CLASS
          </div>
          ...
          <p class="hero-editorial-subtext">
            Cẩm nang tuyển chọn độc lập — 100% ưu đãi có bằng chứng đối soát, quyền lợi học sinh sinh viên và dịch vụ công chính chủ tại TP. Đà Nẵng.
          </p>
      ...
      <section class="section-journey-tiles" aria-label="3 Cửa Vào Hành Trình">
        <div class="section-header-editorial">
          ...
          <h2 class="section-title-editorial">Nhịp Sống & Trải Nghiệm</h2>
        </div>

        <div class="journey-tiles-grid">
          <!-- Tile 1: Ăn Gì Tối Nay -->
          <div class="journey-editorial-tile tile-food" role="button" tabindex="0" data-gateway-target="AN_GI">
            <div class="tile-scene-visual">
              <svg class="tile-svg-art" viewBox="0 0 400 240" fill="none">
                <rect width="400" height="240" fill="#991b1b"/>
                <circle cx="200" cy="120" r="70" fill="#ea580c" opacity="0.8"/>
                <path d="M150 140 Q 200 100 250 140" stroke="#fef08a" stroke-width="8" stroke-linecap="round"/>
                <circle cx="170" cy="110" r="10" fill="#fef08a"/>
                <circle cx="230" cy="110" r="10" fill="#fef08a"/>
              </svg>
            </div>
          ...
          <div class="journey-editorial-tile tile-places" role="button" tabindex="0" data-gateway-target="DI_DAU">
            <div class="tile-scene-visual">
              <svg class="tile-svg-art" viewBox="0 0 400 240" fill="none">
                <rect width="400" height="240" fill="#1e1b4b"/>
                <rect x="130" y="70" width="140" height="100" rx="8" fill="#4338ca"/>
                <polygon points="180,100 230,120 180,140" fill="#38bdf8"/>
              </svg>
            </div>
            <div class="tile-content-overlay">
          ...
          <div class="journey-editorial-tile tile-tools" role="button" tabindex="0" data-gateway-target="MUA_GI">
            <div class="tile-scene-visual">
              <svg class="tile-svg-art" viewBox="0 0 400 240" fill="none">
                <rect width="400" height="240" fill="#064e3b"/>
                <rect x="120" y="60" width="160" height="120" rx="12" fill="#0f766e"/>
      ...
      <section class="section-editorial-rail" aria-label="Chương Trình Học Sinh Sinh Viên">
        ...
        <div class="cards-layout-grid">
          ${officialItems.slice(0, 4).map(item => renderEditorialCard(item)).join('')}
        </div>
      </section>

      <!-- 5. CIVIC FACILITIES & MOBILITY -->
      <section class="section-editorial-rail" aria-label="Dịch Vụ Đô Thị & Giao Thông">
        <div class="section-header-editorial">
          ...
          <h2 class="section-title-editorial">Di Chuyển & Tiện Ích Đô Thị</h2>
        </div>
        <div class="cards-layout-grid">
          ${facilityItems.slice(0, 4).map(item => renderEditorialCard(item)).join('')}
        </div>
      </section>
