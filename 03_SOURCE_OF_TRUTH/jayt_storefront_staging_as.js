/**
 * JAYT COMMUNITY DISCOVERY STOREFRONT (SECTION AS MULTI-TIER REVISION)
 * Version: v3.420.2-staging.as
 * Architecture: True Discovery Storefront, 4-Tier Visual Hierarchy, 6 Consumer Needs,
 * Field-Bound Specificity (Audience, Timing, Conditions, Scope, Observed Time),
 * Zero Generic Repeated Copy, Zero Padding, Zero Affiliate Links.
 * Baseline Rollback: v3.419.0
 */

const JAYT_STOREFRONT_VERSION = 'v3.420.2-staging.as';

const JAYT_DISCOVERY_ITEMS = [
  // =========================================================================
  // TIER 1: VERIFIED DEALS & TIME-LIMITED OFFERS (6 ITEMS)
  // =========================================================================
  {
    id: 'DEAL_LOTTERIA_HAPPY_LUNCH',
    tier: 'VERIFIED_DEAL',
  ...
  },
  {
    ...
    evidence_status: 'Đã đối soát thể lệ chương trình tại starlight.vn',
    official_source_url: 'https://starlight.vn',
    action_type: 'PRIMARY_LINK',
    action_label: 'Xem thông tin rạp'
  },
  {
    id: 'DEAL_CGV_VNPAY_BOGO',
    tier: 'VERIFIED_DEAL',
    tier_name: 'Ưu Đãi Xác Minh',
    badge_label: 'ƯU ĐÃI XÁC MINH',
    title: 'CGV Cinemas — Mua 1 Vé Tặng 1 Vé Qua VNPAY-QR',
    brand: 'CGV Cinemas',
    monogram: 'CGV',
    color_accent: '#be123c',
    category: 'Giải trí',
    scope_text: 'Đà Nẵng: Vincom Ngô Quyền & Vĩnh Trung Plaza',
    audience_target: 'Chủ tài khoản ngân hàng liên kết VNPAY-QR',
    timing_window: 'Thứ 6, Thứ 7 và Chủ Nhật hàng tuần',
    conditions_limit: 'Thanh toán trực tiếp bằng tính năng VNPAY-QR trên app ngân hàng',
    observed_at: '2026-08-29 01:00',
    summary_text: 'Chương trình hợp tác thanh toán Mua 1 vé tặng 1 vé cho các suất chiếu 2D cuối tuần.',
    verbatim_quote: 'CGV x VNPAY: Mua 1 vé tặng 1 vé cuối tuần.',
    evidence_status: 'Đã đối soát cổng ưu đãi tại cgv.vn',
    official_source_url: 'https://www.cgv.vn',
    action_type: 'PRIMARY_LINK',
    action_label: 'Xem ưu đãi liên kết'
  },
  {
    id: 'DEAL_CGV_ZALOPAY_12H',
    tier: 'VERIFIED_DEAL',
    tier_name: 'Ưu Đãi Xác Minh',
    badge_label: 'ƯU ĐÃI XÁC MINH',
    title: 'CGV Cinemas — Vé Suất Trưa Đồng Giá Từ 50.000₫ Qua ZaloPay',
    brand: 'CGV Cinemas',
    monogram: 'CGV',
    color_accent: '#0369a1',
    category: 'Giải trí',
    scope_text: 'Đà Nẵng: Vincom Ngô Quyền & Vĩnh Trung Plaza',
    audience_target: 'Khán giả xem phim suất trưa và dùng ví ZaloPay',
    timing_window: 'Khung giờ chiếu từ 12:00 đến 13:30 Thứ 2 đến Thứ 6',
    conditions_limit: 'Đặt vé trực tuyến qua cổng ZaloPay',
    observed_at: '2026-08-29 01:00',
    summary_text: 'Giá vé ưu đãi từ 50.000₫ cho các suất chiếu nghỉ trưa các ngày trong tuần.',
    verbatim_quote: 'CGV x ZaloPay: Suất chiếu trưa giá từ 50.000đ.',
    evidence_status: 'Đã đối soát cổng ưu đãi tại cgv.vn',
    official_source_url: 'https://www.cgv.vn',
    action_type: 'PRIMARY_LINK',
    action_label: 'Xem ưu đãi ZaloPay'
  },
  ...
  // =========================================================================
  // TIER 3: VERIFIED LOCAL FACILITIES & CIVIC SERVICES (6 ITEMS)
  // =========================================================================
  {
    id: 'FACILITY_DANABUS_CARD',
  ...
  // =========================================================================
  // TIER 4: RADAR TRACKING SOURCES (13 ITEMS)
  // =========================================================================
  {
    id: 'RADAR_GALAXY_CINE',
    tier: 'RADAR_TRACKING',
    ...
    return `
      <div class="jayt-modal-card" role="dialog" aria-modal="true" aria-labelledby="modal-recheck-title">
        ...
        <div class="jayt-modal-footer">
          <a href="${item.official_source_url}" target="_blank" rel="noopener noreferrer" class="jayt-btn-primary">Mở website chính thức &rarr;</a>
      ...
      <header class="jayt-header" role="banner">
        <div class="jayt-header-container">
          ...
          <nav class="jayt-nav-tabs" role="tablist" aria-label="Điều hướng chính">
            ...
            <button class="jayt-nav-tab" data-tab="COLLECTIONS" role="tab" aria-selected="false" id="tab-collections">Bộ sưu tập (6)</button>
      ...
      <main class="jayt-main-content" role="main">
        ...
        <section class="jayt-hero" aria-labelledby="hero-heading">
          <div class="jayt-hero-content">
            <div class="hero-context-badge">ĐÀ NẴNG HÔM NAY • 4 TẦNG MINH BẠCH (${JAYT_DISCOVERY_ITEMS.length} MỤC)</div>
        ...
        <!-- Contextual Collections Rail (6 Needs) -->
        <section class="jayt-collections-rail-section" aria-labelledby="collections-rail-title">
          <div class="collections-rail-header">
            <h2 id="collections-rail-title" class="rail-title">Khám Phá Theo 6 Nhu Cầu Đời Sống</h2>
            <span class="rail-sub">Tuyển chọn theo ngữ cảnh sinh hoạt, học tập và làm việc tại Đà Nẵng</span>
          </div>
          <div class="collections-rail-wrapper" role="region" aria-label="Danh sách 6 bộ sưu tập nhu cầu">
            <div class="collection-card col-highlight" data-col-cat="Ăn uống" tabindex="0" role="button" aria-label="Bộ sưu tập Ăn uống và Bữa trưa">
              <div class="collection-icon-badge">🍕</div>
              <span class="collection-kicker">Ăn uống & Cà phê</span>
              <h3 class="collection-name">Ăn uống & Bữa trưa</h3>
              <span class="collection-count">Lotteria, Domino's, KFC, Highlands...</span>
            </div>
            <div class="collection-card" data-col-cat="Giải trí" tabindex="0" role="button" aria-label="Bộ sưu tập Phim ảnh và Rạp chiếu">
              <div class="collection-icon-badge">🎬</div>
              <span class="collection-kicker">Văn hóa & Phim</span>
              <h3 class="collection-name">Rạp chiếu phim & Suất xem</h3>
              <span class="collection-count">Metiz, Starlight, CGV, Galaxy...</span>
            </div>
            <div class="collection-card" data-col-cat="Đi lại" tabindex="0" role="button" aria-label="Bộ sưu tập Đi lại và Đô thị">
              <div class="collection-icon-badge">🚌</div>
              <span class="collection-kicker">Giao thông đô thị</span>
              <h3 class="collection-name">Xe buýt, Xe đạp & Vé tàu</h3>
              <span class="collection-count">DanaBus, TNGO, Ga Đà Nẵng</span>
            </div>
            <div class="collection-card" data-col-cat="Học tập" tabindex="0" role="button" aria-label="Bộ sưu tập Học tập và Công cụ">
              <div class="collection-icon-badge">🎓</div>
              <span class="collection-kicker">Công cụ & Bản quyền</span>
              <h3 class="collection-name">Công cụ học tập & Nghiên cứu</h3>
              <span class="collection-count">GitHub, Notion, Microsoft, Figma...</span>
            </div>
            <div class="collection-card" data-col-cat="Đời sống" tabindex="0" role="button" aria-label="Bộ sưu tập Đời sống và Y tế">
              <div class="collection-icon-badge">🏥</div>
              <span class="collection-kicker">Hành chính & Y tế</span>
              <h3 class="collection-name">Dịch vụ công & Y tế đời sống</h3>
              <span class="collection-count">Cổng DVC Đà Nẵng, Long Châu, Pharmacity...</span>
            </div>
            <div class="collection-card" data-col-cat="Mua sắm" tabindex="0" role="button" aria-label="Bộ sưu tập Mua sắm thiết yếu">
              <div class="collection-icon-badge">🛒</div>
              <span class="collection-kicker">Tiêu dùng thiết yếu</span>
              <h3 class="collection-name">Siêu thị & Nhà sách</h3>
              <span class="collection-count">Co.opmart, GO!, WinMart, Fahasa...</span>
            </div>
          </div>
        </section>
        ...
        <section class="jayt-control-bar" aria-label="Bộ lọc tiện ích">
          <div class="jayt-filter-group" role="group" aria-label="Lọc theo 6 Nhu cầu">
            ...
            <button class="filter-pill" data-filter-type="category" data-val="Học tập">Học tập & Công cụ (11)</button>
            <button class="filter-pill" data-filter-type="category" data-val="Đời sống">Đời sống & Y tế (4)</button>
            <button class="filter-pill" data-filter-type="category" data-val="Mua sắm">Mua sắm thiết yếu (3)</button>
          </div>
    ...
    html += `
      <div class="tier-section tier-deal-section">
        <div class="tier-section-header">
          ...
          <span class="tier-desc">Giá, thời hạn và điều kiện áp dụng tại Đà Nẵng đã đối soát</span>
        </div>
...
function renderCollectionsView() {
  ...
  return `
    <div class="collections-detailed-view">
      <h2 class="section-main-title">Tất Cả 6 Bộ Sưu Tập Nhu Cầu Đời Sống</h2>
...
function renderAuthenticCard(item) {
  ...
  return `
    <article class="jayt-card ${cardTierClass}" id="card-${item.id}" data-id="${item.id}">
