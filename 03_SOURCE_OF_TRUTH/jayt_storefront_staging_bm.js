...
const JAYT_STOREFRONT_VERSION = 'v3.424.0-staging.bm';
...
function renderDailyGuideHome() {
  ...
  return `
    <div class="home-guide-layout-bm">
      <!-- 1. HERO CITY-COMMERCE TOP FOLD: ĐÀ NẴNG, CHỌN ĐIỀU HAY MỖI NGÀY -->
      <section class="hero-city-commerce-bm" aria-label="Hero Cẩm Nang Thành Phố Đà Nẵng">
        <div class="hero-city-content-container">
          <div class="hero-city-kicker">
            <span class="pulse-dot"></span> 📍 ĐÀ NẴNG &bull; CITY-COMMERCE GUIDE
          </div>
          <h1 class="hero-city-headline">
            Đà Nẵng, Chọn Điều Hay Mỗi Ngày
          </h1>
          <p class="hero-city-subtext">
          ...
          <!-- Interactive 3-Way City Filter Bar -->
          <div class="city-decision-filter-bar">
            <div class="city-filter-col">
              <label for="filter-locality" class="city-filter-label">📍 Khu vực:</label>
              <select id="filter-locality" class="city-filter-select">
            ...
            <div class="city-filter-col">
              <label for="filter-time" class="city-filter-label">⏰ Thời điểm:</label>
              <select id="filter-time" class="city-filter-select">
            ...
            <div class="city-filter-col">
              <label for="filter-budget" class="city-filter-label">💰 Ngân sách:</label>
              <select id="filter-budget" class="city-filter-select">
            ...
            <button id="btn-apply-decision" class="btn-city-filter-submit">Tìm Lựa Chọn Phù Hợp &rarr;</button>
          </div>

          <!-- Hero Dominant Daily Pick Card -->
          <div class="hero-daily-pick-lockup">
            ${verifiedDeals.map(item => renderSpotlightLargeCard(item)).join('')}
          </div>
        </div>
      </section>

      <!-- 2. TỐI NAY CHỌN GÌ? (3 LARGE VISUAL ROUTES) -->
      <section class="section-city-routes" aria-label="3 Lộ Trình Trải Nghiệm Đà Nẵng">
        ...
        <div class="city-routes-grid">
          <!-- Route 1: Ăn Ngon -->
          <div class="city-route-card route-food" role="button" tabindex="0" data-gateway-target="AN_GI">
            <div class="route-card-header">
              <span class="route-icon">🍔</span>
              <span class="route-tag">ẨM THỰC ĐÀ THÀNH</span>
            </div>
            <h3 class="route-title">Ăn ngon tối nay</h3>
            <p class="route-desc">Gợi ý bữa tối phố Huỳnh Thúc Kháng, Chợ Cồn, combo gà giòn, pizza và trà sữa học sinh sinh viên.</p>
            <span class="route-cta-link">Khám phá 7 điểm ăn uống &rarr;</span>
          </div>

          <!-- Route 2: Đi Chơi -->
          <div class="city-route-card route-places" role="button" tabindex="0" data-gateway-target="DI_DAU">
            <div class="route-card-header">
              <span class="route-icon">🎬</span>
              <span class="route-tag">GIẢI TRÍ & ĐI LẠI</span>
            </div>
            <h3 class="route-title">Kèo nhóm đi chơi</h3>
            <p class="route-desc">Suất chiếu rạp CGV/Metiz, dạo ngắm Cầu Rồng phun lửa, Sông Hàn và mạng lưới xe buýt DanaBus.</p>
            <span class="route-cta-link">Xem lịch rạp & đường đi &rarr;</span>
          </div>

          <!-- Route 3: Mua Sắm & Bản Quyền -->
          <div class="city-route-card route-tools" role="button" tabindex="0" data-gateway-target="MUA_GI">
            <div class="route-card-header">
              <span class="route-icon">🛍️</span>
              <span class="route-tag">HỌC TẬP & TIỆN ÍCH</span>
            </div>
            <h3 class="route-title">Mua sắm & Bản quyền</h3>
            <p class="route-desc">Bản quyền GitHub Student, Notion, Canva Pro, Apple Music và thủ tục dịch vụ công TP. Đà Nẵng.</p>
            <span class="route-cta-link">Xem quyền lợi học đường &rarr;</span>
          </div>
        </div>
      </section>
