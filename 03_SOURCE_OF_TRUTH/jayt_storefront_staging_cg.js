/**
 * JAYT COMMUNITY OS — LOCAL NARRATIVE DEPTH & HONEST RANKING (SECTION CG)
 * Release Candidate: v3.427.1-staging.cg
 * Governing Directive: JAYT-245 Section CG (Lines 2046-2070)
 * Key Architecture:
 *  - Honest Audited Ranking Rationale (No Fake Personalization/AI Claims)
 *  - Authentic Local Storytelling & Transit Route Previews
 *  - Vivid Panoramic Hero (Cầu Rồng Center Stage, Light Non-Intrusive Scrim)
 *  - Narrative Modules Replacing Card Walls with Balanced Content Density
 *  - 4 Visual Archetypes: Verified Place, Official Programme, Radar, Voucher Ready
 *  - Differentiated Concrete Outcome Actions (Chỉ đường Maps, Lộ trình làm vé, Xem lịch rạp)
...
if (typeof window !== 'undefined' && window.JAYT_OBSERVABILITY) {
  window.JAYT_OBSERVABILITY.recordEvent('STOREFRONT_INITIALIZED', {
    version: 'v3.427.1-staging.cg',
    environment: 'STAGING_REVIEW_CG',
    dom_isolation: 'STRICT_ZERO_DOM_INJECTION'
  });
}

const JAYT_STOREFRONT_VERSION = 'v3.427.1-staging.cg';
...
// Render Archetype-Driven Primary Spotlight Card with Honest Ranking Rationale (CG Mandate #3, #4)
function renderPrimarySpotlightCard(item, kickerText) {
  ...
  return `
    <article class="primary-archetype-card archetype-${item.visual_archetype.toLowerCase()}" data-item-id="${item.item_id}">
      ...
      <div class="card-main-content">
        ...
        <!-- HONEST RANKING RATIONALE BOX (CG MANDATE #4) -->
...
// Render Compact Secondary Item Card with Concrete Reason to Choose
...
// 1. HOME VIEW (VIVID HERO + TRUE NARRATIVE MODULES)
function renderDailyGuideHome() {
  ...
  return `
    <div class="home-editorial-layout-cf">
      ...
      <!-- 3. TRUE NARRATIVE MODULE 1: ẨM THỰC ĐÀ THÀNH -->
      ...
      <!-- 4. TRUE NARRATIVE MODULE 2: DI CHUYỂN & GIAO THÔNG XANH -->
      ...
      <!-- 5. TRUE NARRATIVE MODULE 3: HỌC TẬP & LÀM VIỆC -->
      ...
      <!-- 6. TRUE NARRATIVE MODULE 4: ĐI CHƠI & THƯ GIÃN TỐI NAY -->
        ...
        <div class="header-inner">
          <div class="brand-lockup" role="button" tabindex="0" data-nav="HOME" aria-label="Về trang chủ JayT">
            ...
            <div class="brand-text-group">
              ...
              <span class="brand-tagline">Local Editorial &bull; v3.427.1-staging.cg</span>
            </div>
          </div>
      ...
      <footer class="jayt-footer-unified" role="contentinfo">
        <div class="footer-inner">
          <div class="footer-brand-col">
            ...
            <span class="footer-version">Phiên bản: v3.427.1-staging.cg &bull; Staging Review CG</span>
          </div>
        </div>
      </footer>
