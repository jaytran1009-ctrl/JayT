...
const JAYT_STOREFRONT_VERSION = 'v3.422.1-staging.bb';
  ...
  return `
    <div class="home-guide-layout">
      ...
      <section class="guide-hero-section">
        ...
        <p class="hero-description">Bữa trưa tiết kiệm, suất xem phim rạp, xe buýt đô thị hay công cụ học tập — Phân tầng minh bạch theo cấp độ xác minh.</p>
      ...
      <!-- Section 1: Ưu Đãi Xác Minh (1 Field-Certified Item) -->
      <section class="content-rail-section">
        ...
        <div class="cards-layout-grid">
          ${dealItems.filter(i => i.item_id === 'DEAL_CGV_VNPAY_BOGO').map(item => renderEditorialCard(item)).join('')}
        </div>
      </section>

      <!-- Section 1B: Nguồn Ưu Đãi Đang Rà Soát Theo Tiêu Chuẩn AU (4 Deals Pending) -->
      <section class="content-rail-section">
        <div class="rail-header">
          <div>
