...
const JAYT_STOREFRONT_VERSION = 'v3.424.1-staging.bn';
...
function renderDailyGuideHome() {
  ...
  return `
    <div class="home-guide-layout-bn">
      <!-- 1. DA NANG ARRIVAL HERO (68-78vh): KHÔNG DÙNG FORM LỌC KHỔNG LỒ -->
      <section class="hero-danang-arrival-bn" aria-label="Hero Cẩm Nang Đà Nẵng">
        <div class="hero-arrival-backdrop"></div>
        <div class="hero-arrival-inner">
