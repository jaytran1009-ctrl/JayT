/**
 * RETENTION SUPPLY EXTRACTOR & SSOT GENERATOR (JAYT-118)
 * 
 * Directives:
 * 1. Strict 3-Tier Classification (Verified Savings, Needs Recheck, Public Menu/Utility).
 ...
 * 4. Clean pricing without fake strikethroughs.
 * 5. Embed dynamic verification metadata and added_at / last_verified_at timestamps for delta tracking.
 */
...
// 1. TIER 1: VERIFIED LIMITED-TIME SAVINGS DEALS (4 DEALS)
const verifiedSavingsDeals = [
  ...
  {
    id: "VERIFIED_118_METIZ_U22_AND_SUPER_MONDAY",
    tier: "VERIFIED_DEAL",
    tier_label: "ƯU ĐÃI ĐÃ XÁC MINH CÓ HẠN",
    ...
    evidence: {
      ...
      file_sha256: "",
      last_verified_at: "2026-08-25T23:18:00+07:00"
    },
    claims_to_verify: [
...
// 3. TIER 3: PUBLIC MENU & UTILITY PRICING (NO FAKE STRIKETHROUGH)
const publicMenuCombos = [
  ...
  {
    id: "MENU_118_GOGI_HOUSE_SIGNATURE",
    tier: "PUBLIC_MENU_PRICING",
    tier_label: "GIÁ MENU CÔNG KHAI THAM KHẢO",
    ...
    source_note: "Giá menu niêm yết công khai tại gogi.com.vn.",
  ...
  {
    id: "UTILITY_118_DANABUS_TRANSIT",
    tier: "PUBLIC_MENU_PRICING",
    tier_label: "GIÁ TIỆN ÍCH CÔNG CỘNG NIÊM YẾT",
...
function buildDailySupplyFeed118() {
  console.log('⚡ Đang đối soát chứng cứ đĩa cho Daily Supply Feed 118...');
  ...
  const feed118 = {
    ...
    dataset_version: "118.0.0",
    generated_at: "2026-08-25T23:18:00+07:00",
    release_directive: "JAYT-118-REAL-SUPPLY-AND-HONEST-VALIDATION",
    classification_policy: "STRICT_3_TIER_WITH_5_ATTRIBUTE_VALIDATION_AND_DELTA_DETECTION",
    metrics_summary: {
  ...
  const outputPath = path.join(sotDir, 'daily_supply_feed_118.json');
  fs.writeFileSync(outputPath, JSON.stringify(feed118, null, 2), 'utf8');
  console.log(`✅ Đã tạo thành công: ${outputPath}`);
  return feed118;
}

buildDailySupplyFeed118();
