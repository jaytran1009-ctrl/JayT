# EVIDENCE DOSSIER: CAND-DNG-METIZ-SUPER-MONDAY-REAL

## 1. Thông Tin Định Danh Candidate
- **Candidate ID**: `CAND-DNG-METIZ-SUPER-MONDAY-REAL`
- **Deal ID**: `DNG-METIZ-SUPER-MONDAY-REAL`
...
## 4. Danh Mục Artifacts Fresh 069-Step2B
- **Receipt**: `05_DEAL_AND_AFFILIATE/raw_evidence/batch_069_step2b_fresh_metiz/FRESH_CAPTURE_RECEIPT_METIZ_SUPER_MONDAY.json`
- **PNG Screenshot**: `fresh_metiz_super_monday_capture.png` (`5b443193bd1407a811e9f239f22fc4c5ee7bcfbe77464e1616209653859dcf3e`)
- **HTML DOM**: `fresh_metiz_super_monday_capture.html` (`c58ccb9e6eae5517961dad4efc74e7ef3d796dc64c0a0dda03e707d29b7345c4`)
- **Raw Text**: `fresh_metiz_super_monday_capture.txt` (`a7a568b0ad7d7031606e79e9c9bf679c33dc1f3500e36cd377cf4fe2d0ce203c`)
