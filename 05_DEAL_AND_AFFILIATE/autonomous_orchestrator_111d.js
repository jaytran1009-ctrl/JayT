/**
 * JAYT AUTONOMOUS ORCHESTRATOR (111D)
 ...
 * 2. Fresh Puppeteer capture across official store locators with stealth headers
 ...
 * 6. Deduplicate against 26 canonical locations on SOT
 ...
 * 10. Emit ORCHESTRATION_RECEIPT_111D.json & Batch Report
 */
...
const RECEIPT_PATH = path.join(repoRoot, '08_RELEASE_VAULT/ORCHESTRATION_RECEIPT_111D.json');
...
const OFFICIAL_STORE_LOCATOR_TARGETS = [
  { id: 'LOC_111D_01_HIGHLANDS', brand: 'Highlands Coffee', sector: 'COFFEE_TEA', url: 'https://www.highlandscoffee.com.vn/vn/he-thong-cua-hang.html' },
  { id: 'LOC_111D_02_TCH', brand: 'The Coffee House', sector: 'COFFEE_TEA', url: 'https://thecoffeehouse.com/pages/danh-sach-cua-hang' },
  { id: 'LOC_111D_03_PHELA', brand: 'Phê La', sector: 'COFFEE_TEA', url: 'https://phela.vn/he-thong-cua-hang/' },
  { id: 'LOC_111D_04_PHUCLONG', brand: 'Phúc Long Coffee and Tea', sector: 'COFFEE_TEA', url: 'https://phuclong.com.vn/he-thong-cua-hang-phuc-long' },
  { id: 'LOC_111D_05_STARBUCKS', brand: 'Starbucks Vietnam', sector: 'COFFEE_TEA', url: 'https://www.starbucks.vn/store-locator/' },
  { id: 'LOC_111D_06_GONGCHA', brand: 'Gong Cha Vietnam', sector: 'COFFEE_TEA', url: 'https://gongcha.com.vn/cua-hang/' },
  { id: 'LOC_111D_07_JOLLIBEE', brand: 'Jollibee Vietnam', sector: 'FNB_FASTFOOD', url: 'https://jollibee.com.vn/cua-hang' },
  { id: 'LOC_111D_08_KFC', brand: 'KFC Vietnam', sector: 'FNB_FASTFOOD', url: 'https://www.kfcvietnam.com.vn/' },
  { id: 'LOC_111D_09_LOTTERIA', brand: 'Lotteria Vietnam', sector: 'FNB_FASTFOOD', url: 'https://www.lotteria.vn/store' },
  { id: 'LOC_111D_10_PIZZAHUT', brand: 'Pizza Hut Vietnam', sector: 'FNB_FASTFOOD', url: 'https://pizzahut.vn/he-thong-nha-hang' },
  { id: 'LOC_111D_11_DOMINOS', brand: "Domino's Pizza Vietnam", sector: 'FNB_FASTFOOD', url: 'https://dominos.vn/cua-hang' },
  { id: 'LOC_111D_12_PIZZA_COMPANY', brand: 'The Pizza Company', sector: 'FNB_FASTFOOD', url: 'https://thepizzacompany.vn/he-thong-nha-hang' },
  { id: 'LOC_111D_13_CGV', brand: 'CGV Cinemas Vietnam', sector: 'CINEMA', url: 'https://www.cgv.vn/default/cinox/site/' },
  { id: 'LOC_111D_14_GALAXY', brand: 'Galaxy Cinema', sector: 'CINEMA', url: 'https://www.galaxycine.vn/rap-gia-ve' },
  { id: 'LOC_111D_15_METIZ', brand: 'Metiz Cinema', sector: 'CINEMA', url: 'https://metiz.vn/' },
  { id: 'LOC_111D_16_LOTTECINEMA', brand: 'Lotte Cinema Vietnam', sector: 'CINEMA', url: 'https://lottecinemavn.com/LCHS/Contents/Cinema/Cinema-Detail.aspx' },
  { id: 'LOC_111D_17_STARLIGHT', brand: 'Starlight Cinema', sector: 'CINEMA', url: 'https://starlight.vn/' },
  { id: 'LOC_111D_18_COOPMART', brand: 'Co.opmart', sector: 'RETAIL_MART', url: 'https://co-opmart.com.vn/he-thong-co-opmart' },
  { id: 'LOC_111D_19_GO', brand: 'GO! Vietnam', sector: 'RETAIL_MART', url: 'https://sieuthi-go.vn/about-us/he-thong-sieu-thi.html' },
  { id: 'LOC_111D_20_WINMART', brand: 'WinMart / WinMart+', sector: 'RETAIL_MART', url: 'https://winmart.vn/danh-sach-cua-hang' },
  { id: 'LOC_111D_21_CIRCLEK', brand: 'Circle K Vietnam', sector: 'RETAIL_MART', url: 'https://www.circlek.com.vn/vi/he-thong-circle-k/' },
  { id: 'LOC_111D_22_GS25', brand: 'GS25 Vietnam', sector: 'RETAIL_MART', url: 'https://gs25.com.vn/cua-hang.html' },
  { id: 'LOC_111D_23_BACHHOAXANH', brand: 'Bách Hóa Xanh', sector: 'RETAIL_MART', url: 'https://www.bachhoaxanh.com/he-thong-sieu-thi' },
  { id: 'LOC_111D_24_TRUNGNGUYEN', brand: 'Trung Nguyên E-Coffee', sector: 'COFFEE_TEA', url: 'https://trungnguyenecoffee.com/danh-sach-cua-hang/' },
  { id: 'LOC_111D_25_CONG_CAPHE', brand: 'Cộng Cà Phê', sector: 'COFFEE_TEA', url: 'https://congcaphe.com/stores' }
];
...
async function captureTarget(browser, target, outputDir) {
  ...
  const isSuccessful = !errorMsg && (httpStatus === 200 || httpStatus === 0 || httpStatus === 304);
...
async function runAutonomousOrchestration() {
  ...
  const runId = `RUN_111D_${Date.now()}`;
  console.log(`\n======================================================`);
  console.log(`🚀 [ORCHESTRATOR-111D] Bắt đầu chu trình tự vận hành: ${runId}`);
  ...
  try {
    ...
    console.log(`\n4️⃣ Đối soát & Khử trùng lặp (Deduplicate) với các địa điểm Canonical SOT...`);
    const dataset = JSON.parse(fs.readFileSync(DATASET_PATH, 'utf8'));
    const { newlyPromoted, duplicates } = deduplicateAndPromoteVenues(extractedVenues, dataset);

    console.log(`   Số địa điểm trùng với Canonical hiện hữu: ${duplicates.length}`);
    ...
    try {
      execSync('node 07_QUALITY_ASSURANCE/test_scheduler_proof_and_supply_expansion_111d.js', { cwd: repoRoot, stdio: 'inherit' });
    ...
    const receipt = {
      ...
      failed_sources: failedCaptures.map(f => ({ target_id: f.target_id, brand: f.brand, url: f.source_url, http_status: f.http_status, error: f.error })),
...
- **Số nguồn phản hồi thành công (HTTP 200/304)**: **${receipt.valid_sources_count}**
...
- **Số cơ sở trùng lặp với Canonical SOT**: **${receipt.duplicated_venues_count}**
- **Số địa điểm MỚI được thăng hạng (Verified New)**: **${receipt.newly_promoted_venues_count}**
- **Tổng số địa điểm chính thức trên SOT**: **${receipt.total_canonical_sot_venues}**
- **Số cơ sở còn lại trong kho cách ly**: **${receipt.quarantined_remaining_count}**

---

## 2. DANH SÁCH NGUỒN LỖI / 404 / CHUYỂN HƯỚNG ĐƯỢC GHI NHẬN (AUDIT ERROR LOG)
${receipt.failed_sources.map(f => `- **[${f.brand}]** (${f.url}) -> HTTP Status: ${f.http_status}, Lỗi: ${f.error || 'N/A'}`).join('\n')}

---

## 3. DANH SÁCH ĐỊA ĐIỂM MỚI ĐƯỢC THĂNG HẠNG VÀO BETA
${newlyPromoted.length === 0 ? '*Đợt quét hiện tại duy trì nguyên vẹn 26 địa điểm chính thức đã xác thực trên SOT; không phát hiện thêm địa điểm mới ngoài danh mục đã đối soát.*' : newlyPromoted.map((item, idx) => `### ${idx + 1}. [${item.brand}] ${item.venue_name}
...
`;
    ...
    console.log(`\n🎉 [ORCHESTRATOR-111D] Hoàn tất chu trình tự vận hành thành công! Báo cáo: AUTONOMOUS_OPERATIONS_BATCH_REPORT_${runId}.md`);
    return receipt;
...
if (require.main === module) {
  runAutonomousOrchestration().catch(err => {
    console.error('Lỗi thực thi Orchestrator 111D:', err);
    process.exit(1);
  });
}
