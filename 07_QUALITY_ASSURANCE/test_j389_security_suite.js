/**
 * 07_QUALITY_ASSURANCE/test_j389_security_suite.js
 * Mandate: WORK_ORDER_J389_PROVENANCE_HARVEST (R2_WORKER_AND_BENCHMARK)
 ...
 * 5. Public GET endpoint returns version 3.445.0-j389 with honest ephemeral SLA declaration
 */
...
async function runSecuritySuite() {
  console.log('================================================================');
  console.log('RUNNING JAYT-389 SECURITY & STATUS CODE UNIT TEST SUITE');
  console.log('================================================================\n');
  ...
  // -------------------------------------------------------------
  {
    ...
    const versionMatch = j && j.version === '3.445.0-j389';
    record('Public GET returns version 3.445.0-j389 with honest SLA declaration', res.statusCode === 200 && honestSla && versionMatch);
  }
  ...
  const receipt = {
    ...
    "receipt_id": "JAYT_389_SECURITY_RECEIPT",
    "cycle": "JAYT-389",
    ...
    "test_suite_execution": {
      "script": "07_QUALITY_ASSURANCE/test_j389_security_suite.js",
      "total_tests": total,
      "passed_tests": passed,
  ...
  const receiptPath = path.resolve('07_QUALITY_ASSURANCE/runtime_evidence/JAYT_389_SECURITY_RECEIPT.json');
