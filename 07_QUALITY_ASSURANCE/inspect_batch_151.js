...
if (fs.existsSync(runsBase)) {
  ...
  if (dirs.length > 0) {
    ...
    if (fs.existsSync(manifestPath)) {
      ...
      console.log('Cohort Summary:', JSON.stringify(manifest.cohort_summary, null, 2));
...
const regPath = path.join(repoRoot, '05_DEAL_AND_AFFILIATE', 'autonomous_schedule_registry_151.json');
