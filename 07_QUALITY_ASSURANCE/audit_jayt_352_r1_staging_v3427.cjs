...
async function runAudit() {
  console.log('==================================================================');
  console.log('🚀 JAYT-352-R1 EVIDENCE REALIGNMENT AUDIT & BENCHMARK (v3.427.0)');
  console.log('==================================================================');
  ...
  // -------------------------------------------------------------
  // TEST MODULE B: 7-DAY SAVINGS TIMELINE & BENCHMARK (REALIGNED)
  // -------------------------------------------------------------
  ...
  // Check 7-day schedule content logic per J352-R1 evidence realignment
  const calendarContentCheck = await page.evaluate(() => {
    const cal = window.SAVINGS_CALENDAR_DATA;
    const tuesdayGalaxy = cal.tuesday.items.find(i => i.event_name.includes('Galaxy Cinema Happy Day'));
    const zeroMetizTuesday = !cal.tuesday.items.some(i => i.brand.includes('Metiz'));
    ...
    return {
      ...
      tuesdayHasGalaxyHappyDay: cal.tuesday.has_deals === true && !!tuesdayGalaxy,
      tuesdayGalaxyHashExact: tuesdayGalaxy?.raw_sha256 === 'a851859ad667285cce2c1f9518478cd31cd7dcac01e8de45d94260a7a314dbdd',
      tuesdayMetizWithheld: zeroMetizTuesday && cal.tuesday.items.length === 1,
      wednesdayMetizWithheld: cal.wednesday.has_deals === false && cal.wednesday.items.length === 0,
      thursdayMetizWithheld: cal.thursday.has_deals === false && cal.thursday.items.length === 0,
      fridayGalaxyU22Withheld: cal.friday.has_deals === false && cal.friday.items.length === 0,
  ...
  testResults.module_b_calendar_timeline = {
    ...
    tuesday_galaxy_happy_day_verified: (calendarContentCheck.tuesdayHasGalaxyHappyDay && calendarContentCheck.tuesdayGalaxyHashExact) ? 'PASS' : 'FAIL',
    tuesday_metiz_u22_withheld: calendarContentCheck.tuesdayMetizWithheld ? 'PASS' : 'FAIL',
    wednesday_metiz_u22_withheld: calendarContentCheck.wednesdayMetizWithheld ? 'PASS' : 'FAIL',
    thursday_metiz_u22_withheld: calendarContentCheck.thursdayMetizWithheld ? 'PASS' : 'FAIL',
    friday_galaxy_u22_withheld: calendarContentCheck.fridayGalaxyU22Withheld ? 'PASS' : 'FAIL',
  ...
  console.log('✓ Module B Acceptance (Realigned):', testResults.module_b_calendar_timeline);
