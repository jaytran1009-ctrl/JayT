...
try {
  const result = applyProjectMemoryTransaction067({
    ...
    affectedFiles: [
      ...
      '07_QUALITY_ASSURANCE/runtime_evidence/rights_proof/CARD_VISUAL_RIGHTS_DOSSIER_218R.md',
      '07_QUALITY_ASSURANCE/fetch_genuine_promo_posters_218.js',
      '07_QUALITY_ASSURANCE/test_promo_media_truth_218R.js',
      '07_QUALITY_ASSURANCE/certify_promo_media_truth_218R.js',
      '07_QUALITY_ASSURANCE/runtime_evidence/evidence_218R_certification/CERTIFICATION_218R_LIVE_REPORT.json',
      '08_RELEASE_VAULT/DISCLOSURE_218R_PROMO_MEDIA_TRUTH.md'
    ]
  });

  console.log('✅ [TRANSACTION-218R-RESULT]');
