...
const queryCmd = 'schtasks /query /tn "JAYT_AUTONOMOUS_SUPPLY_WORKER_149" /fo LIST /v';
...
const regPath = path.join(repoRoot, '05_DEAL_AND_AFFILIATE', 'autonomous_schedule_registry_149.json');
